...
public abstract class AbstractC0391a {
    ...
    public static String b(int i3, int i10, byte[] bArr) {
        ...
        int i14 = 0;
        while (i11 < i3 + i10) {
            char charAt = f9291g[i13].charAt(bArr[i11]);
            switch (charAt) {
                case 65520:
                case 65521:
                case 65522:
                ...
                case 65531:
                    ...
                    i11 += 5;
                    sb2.append(new DecimalFormat(StubApp.getString2(8506)).format(i15 + bArr[i11]));
                    break;
            }
            int i16 = i12 - 1;
            if (i12 == 0) {

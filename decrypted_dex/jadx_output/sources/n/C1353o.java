...
public class C1353o extends AutoCompleteTextView {

    /* renamed from: d, reason: collision with root package name */
    public static final int[] f17567d = {R.attr.popupBackground};

    /* renamed from: a, reason: collision with root package name */
    public final C1355p f17568a;

    /* renamed from: b, reason: collision with root package name */
    public final C1322X f17569b;

    /* renamed from: c, reason: collision with root package name */
    public final C1296B f17570c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1353o(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 2130903103);
        P0.a(context);
        O0.a(this, getContext());
        a5.c E10 = a5.c.E(getContext(), attributeSet, f17567d, 2130903103);
    ...
    public final void drawableStateChanged() {
        ...
        C1355p c1355p = this.f17568a;
        if (c1355p != null) {
            c1355p.a();
        }
        C1322X c1322x = this.f17569b;
        if (c1322x != null) {
            c1322x.b();
        }
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f17570c.f(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f17570c.d(keyListener));
    }

...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    private static final BufferedReader bufferedReader(File file, Charset charset, int i3) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        return new BufferedReader(new InputStreamReader(new FileInputStream(file), charset), i3);
    }

    public static /* synthetic */ BufferedReader bufferedReader$default(File file, Charset charset, int i3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i10 & 2) != 0) {
    ...
    private static final BufferedWriter bufferedWriter(File file, Charset charset, int i3) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        return new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), charset), i3);
    }

    public static /* synthetic */ BufferedWriter bufferedWriter$default(File file, Charset charset, int i3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i10 & 2) != 0) {
    ...
    public static ByteBuffer byteBufferForEncoding(int i3, CharsetEncoder encoder) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        ByteBuffer allocate = ByteBuffer.allocate(i3 * ((int) Math.ceil(encoder.maxBytesPerChar())));
    ...
    public static /* synthetic */ PrintWriter printWriter$default(File file, Charset charset, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(file, "<this>");
        ...
        try {
            ...
            if (i10 > 0) {
                ...
                if (read2 != -1) {
                    ...
                    bArr = ArraysKt.copyInto(buffer, copyOf, i3, 0, exposingBufferByteArrayOutputStream.size());
                }
            }
    ...
    public static /* synthetic */ InputStreamReader reader$default(File file, Charset charset, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(file, "<this>");
    ...
    public static /* synthetic */ Object useLines$default(File file, Charset charset, Function1 block, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(file, "<this>");
    ...
    public static void writeTextImpl(OutputStream outputStream, String text, Charset charset) {
        ...
        while (i3 < text.length()) {
            int min = Math.min(8192 - i10, text.length() - i3);
            int i11 = i3 + min;
            char[] array = allocate.array();
            Intrinsics.checkNotNullExpressionValue(array, "array(...)");
            text.getChars(i3, i11, array, i10);
            allocate.limit(min + i10);
            i10 = 1;
            if (!newReplaceEncoder.encode(allocate, byteBufferForEncoding, i11 == text.length()).isUnderflow()) {
    ...
    public static /* synthetic */ OutputStreamWriter writer$default(File file, Charset charset, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkNotNullParameter(file, "<this>");
    ...
    public static final void forEachBlock(File file, int i3, Function2<? super byte[], ? super Integer, Unit> action) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        ?? r22 = new byte[RangesKt.coerceAtLeast(i3, 512)];
        FileInputStream fileInputStream = new FileInputStream(file);
        while (true) {
            try {

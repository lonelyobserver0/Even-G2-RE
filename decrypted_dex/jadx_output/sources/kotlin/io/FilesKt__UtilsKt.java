...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
            ...
            while (it.hasNext()) {
                ...
                if (next.exists()) {
                    ...
                    if (next.isDirectory()) {
                        ...
                        boolean z10 = z2;
                        if (copyTo$default(next, file2, z10, 0, 4, null).length() != next.length() && onError.invoke(next, new IOException("Source file wasn't copied completely, length of destination file differs.")) == OnErrorAction.TERMINATE) {
                            return false;
                        }
                        z2 = z10;
                    }
    ...
    public static /* synthetic */ boolean copyRecursively$default(File file, File file2, boolean z2, Function2 function2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            z2 = false;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final Unit copyRecursively$lambda$0$FilesKt__UtilsKt(Function2 function2, File f10, IOException e10) {
    ...
    public static final File copyTo(File file, File target, boolean z2, int i3) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        if (!file.exists()) {
    ...
    public static /* synthetic */ File copyTo$default(File file, File file2, boolean z2, int i3, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            z2 = false;
        }
        if ((i10 & 4) != 0) {
    ...
    public static final String getInvariantSeparatorsPath(File file) {
        ...
        replace$default = StringsKt__StringsJVMKt.replace$default(path, c10, '/', false, 4, (Object) null);
    ...
    public static final File resolve(File file, File relative) {
        ...
        if (file2.length() != 0) {
            char c10 = File.separatorChar;
            endsWith$default = StringsKt__StringsKt.endsWith$default((CharSequence) file2, c10, false, 2, (Object) null);
            if (!endsWith$default) {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i3 < size2) {
            ...
            List drop = CollectionsKt.drop(normalize$FilesKt__UtilsKt.getSegments(), i3);
            String separator = File.separator;
            Intrinsics.checkNotNullExpressionValue(separator, "separator");
            CollectionsKt.l(separator, sb2, drop);
        }
        return sb2.toString();
    }

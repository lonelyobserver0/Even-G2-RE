...
public final class FileTreeWalk implements Sequence<File> {
    ...
    private FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1<? super File, Boolean> function1, Function1<? super File, Unit> function12, Function2<? super File, ? super IOException, Unit> function2, int i3) {
        this.start = file;
    ...
    public final FileTreeWalk maxDepth(int depth) {
        ...
        throw new IllegalArgumentException(u.s("depth must be positive, but was ", depth, '.'));
    }
    ...
    public /* synthetic */ FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1 function1, Function1 function12, Function2 function2, int i3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i10 & 2) != 0 ? FileWalkDirection.TOP_DOWN : fileWalkDirection, function1, function12, function2, (i10 & 32) != 0 ? IntCompanionObject.MAX_VALUE : i3);
    }

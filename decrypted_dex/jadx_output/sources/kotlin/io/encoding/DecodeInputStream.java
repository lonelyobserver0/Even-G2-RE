...
final class DecodeInputStream extends InputStream {
    ...
    private final void copyByteBufferInto(byte[] dst, int dstOffset, int length) {
        ...
        ArraysKt.copyInto(bArr, dst, dstOffset, i3, i3 + length);
    ...
    private final int decodeSymbolBufferInto(byte[] dst, int dstOffset, int dstEndIndex, int symbolBufferLength) {
        int i3 = this.byteBufferEndIndex;
        this.byteBufferEndIndex = i3 + this.base64.decodeIntoByteArray(this.symbolBuffer, this.byteBuffer, i3, 0, symbolBufferLength);
    ...
    private final void shiftByteBufferToStartIfNeeded() {
        ...
        int i3 = this.byteBufferEndIndex;
        if ((this.symbolBuffer.length / 4) * 3 > length - i3) {
            ArraysKt.copyInto(bArr, bArr, 0, this.byteBufferStartIndex, i3);
    ...
    public int read() {
        int i3 = this.byteBufferStartIndex;
        if (i3 < this.byteBufferEndIndex) {
            int i10 = this.byteBuffer[i3] & UByte.MAX_VALUE;
            this.byteBufferStartIndex = i3 + 1;
            resetByteBufferIfEmpty();
            return i10;
        }
    ...
    public int read(byte[] destination, int offset, int length) {
        ...
        if (offset >= 0 && length >= 0 && (i3 = offset + length) <= destination.length) {
            if (!this.isClosed) {
                if (this.isEOF) {
                    return -1;
                }
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (readNextSymbol == -1) {
                            ...
                            this.symbolBuffer[i11] = (byte) readNextSymbol;
                            i11++;
                        } else {
                            i11 = handlePaddingSymbol(i11);
                            this.isEOF = true;
                        }
                    }
                    if (!z10 && i11 != min) {
                    ...
                    byteBufferLength -= i11;
                    i10 += decodeSymbolBufferInto(destination, i10, i3, i11);
                }
                if (i10 == offset && z2) {
                    return -1;
                }
        ...
        StringBuilder l9 = AbstractC1482f.l(offset, "offset: ", length, ", length: ", ", buffer size: ");
        l9.append(destination.length);

...
final class ClosedDoubleRange implements ClosedFloatingPointRange<Double> {
    ...
    public ClosedDoubleRange(double d8, double d10) {
        this._start = d8;
    ...
    public boolean lessThanOrEquals(double a3, double b2) {
        return a3 <= b2;
    }
    ...
    public /* bridge */ /* synthetic */ boolean lessThanOrEquals(Double d8, Double d10) {
        return lessThanOrEquals(d8.doubleValue(), d10.doubleValue());
    }
}

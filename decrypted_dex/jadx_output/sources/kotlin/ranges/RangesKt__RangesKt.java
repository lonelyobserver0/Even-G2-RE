...
public class RangesKt__RangesKt {
    ...
    public static final ClosedFloatingPointRange<Double> rangeTo(double d8, double d10) {
        return new ClosedDoubleRange(d8, d10);
    }

    @SinceKotlin(version = "1.9")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final OpenEndRange<Double> rangeUntil(double d8, double d10) {
        return new OpenEndDoubleRange(d8, d10);
    }

    @SinceKotlin(version = "1.1")
    public static ClosedFloatingPointRange<Float> rangeTo(float f10, float f11) {

...
public final class DropSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public DropSequence(Sequence<? extends T> sequence, int i3) {
    ...
    public Sequence<T> drop(int n10) {
        int i3 = this.count + n10;
        return i3 < 0 ? new DropSequence(this, n10) : new DropSequence(this.sequence, i3);
    }
    ...
    public Sequence<T> take(int n10) {
        int i3 = this.count;
        int i10 = i3 + n10;
        return i10 < 0 ? new TakeSequence(this, n10) : new SubSequence(this.sequence, i3, i10);
    }
}

...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    public static final <R> Sequence<R> filterIsInstance(Sequence<?> sequence, Class<R> klass) {
        ...
        Sequence<R> filter = SequencesKt___SequencesKt.filter(sequence, new b(klass, 1));
    ...
    public static final /* synthetic */ Double m1314max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1322maxOrNull((Sequence<Double>) sequence);
    }
    ...
    public static final /* synthetic */ <T, R extends Comparable<? super R>> T maxBy(Sequence<? extends T> sequence, Function1<? super T, ? extends R> function1) {
        Iterator x7 = u.x(sequence, "<this>", function1, "selector");
        if (!x7.hasNext()) {
            return null;
        }
        ?? r02 = (Object) x7.next();
    ...
    public static final /* synthetic */ Double m1316min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1330minOrNull((Sequence<Double>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: max, reason: collision with other method in class */
    public static final /* synthetic */ Float m1315max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1323maxOrNull((Sequence<Float>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min, reason: collision with other method in class */
    public static final /* synthetic */ Float m1317min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1331minOrNull((Sequence<Float>) sequence);
    }

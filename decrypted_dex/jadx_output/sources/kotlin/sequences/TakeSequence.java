...
public final class TakeSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public TakeSequence(Sequence<? extends T> sequence, int i3) {
        ...
        this.count = i3;
        if (i3 < 0) {
            throw new IllegalArgumentException(u.s("count must be non-negative, but was ", i3, '.').toString());
        }
    }
    ...
    public Sequence<T> drop(int n10) {
        int i3 = this.count;
        return n10 >= i3 ? SequencesKt__SequencesKt.emptySequence() : new SubSequence(this.sequence, n10, i3);
    }

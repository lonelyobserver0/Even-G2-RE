...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public /* synthetic */ DoubleTimeMark(double d8, AbstractDoubleTimeSource abstractDoubleTimeSource, long j, DefaultConstructorMarker defaultConstructorMarker) {
            this(d8, abstractDoubleTimeSource, j);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: elapsedNow-UwyO8pc, reason: not valid java name */
        public long mo1358elapsedNowUwyO8pc() {
            return Duration.m1396minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1373equalsimpl0(mo1360minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1459getZEROUwyO8pc());
        }
        ...
        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1389hashCodeimpl(Duration.m1397plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }
        ...
        public long mo1360minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1373equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1393isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1459getZEROUwyO8pc();
                    }
                    long m1396minusLRDsOJo = Duration.m1396minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1373equalsimpl0(duration, Duration.m1412unaryMinusUwyO8pc(m1396minusLRDsOJo)) ? Duration.INSTANCE.m1459getZEROUwyO8pc() : Duration.m1397plusLRDsOJo(duration, m1396minusLRDsOJo);
                }
            }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt__DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1408toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }

        private DoubleTimeMark(double d8, AbstractDoubleTimeSource timeSource, long j) {
        ...
        public ComparableTimeMark mo1361plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1397plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1459getZEROUwyO8pc(), null);
    }
}

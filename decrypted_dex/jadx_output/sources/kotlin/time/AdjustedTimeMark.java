...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1358elapsedNowUwyO8pc() {
        return Duration.m1396minusLRDsOJo(this.mark.mo1358elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public /* bridge */ TimeMark mo1359minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1478minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1361plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1397plusLRDsOJo(this.adjustment, duration), null);
    }

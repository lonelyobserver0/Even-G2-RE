...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            ...
            return Duration.m1367compareToLRDsOJo(comparableTimeMark.mo1360minusUwyO8pc(other), Duration.INSTANCE.m1459getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m1363minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1361plusLRDsOJo(Duration.m1412unaryMinusUwyO8pc(j));
        }
    }

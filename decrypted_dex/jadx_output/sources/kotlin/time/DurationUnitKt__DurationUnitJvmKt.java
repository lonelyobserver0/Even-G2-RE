...
class DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final double convertDurationUnit(double d8, DurationUnit sourceUnit, DurationUnit targetUnit) {
        Intrinsics.checkNotNullParameter(sourceUnit, "sourceUnit");
        Intrinsics.checkNotNullParameter(targetUnit, "targetUnit");
        long convert = targetUnit.getTimeUnit().convert(1L, sourceUnit.getTimeUnit());
        return convert > 0 ? d8 * convert : d8 / sourceUnit.getTimeUnit().convert(1L, targetUnit.getTimeUnit());
    }

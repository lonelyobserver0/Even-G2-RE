...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1499copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        return timedValue.m1501copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1501copyRFiDyg4(T value, long duration) {
    ...
    public final long m1502getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t3 = this.value;
        return Duration.m1389hashCodeimpl(this.duration) + ((t3 == null ? 0 : t3.hashCode()) * 31);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1408toStringimpl(this.duration)) + ')';
    }

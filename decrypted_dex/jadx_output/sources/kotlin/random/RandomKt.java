...
public final class RandomKt {
    ...
    public static final void checkRangeBounds(int i3, int i10) {
        if (i10 <= i3) {
            throw new IllegalArgumentException(boundsErrorMessage(Integer.valueOf(i3), Integer.valueOf(i10)).toString());
        }
    }
    ...
    public static final int takeUpperBits(int i3, int i10) {
        return (i3 >>> (32 - i10)) & ((-i10) >> 31);
    }
    ...
    public static final void checkRangeBounds(long j, long j3) {
        if (j3 <= j) {
            throw new IllegalArgumentException(boundsErrorMessage(Long.valueOf(j), Long.valueOf(j3)).toString());
        }
    }

    public static final void checkRangeBounds(double d8, double d10) {
        if (d10 <= d8) {
            throw new IllegalArgumentException(boundsErrorMessage(Double.valueOf(d8), Double.valueOf(d10)).toString());
        }
    }
}

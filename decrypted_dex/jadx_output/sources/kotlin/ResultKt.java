...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        return m43exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(m43exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r8) {
        return Result.m46isFailureimpl(obj) ? r8 : obj;
    }
    ...
    private static final <R, T> Object map(Object obj, Function1<? super T, ? extends R> transform) {
        ...
        return Result.m47isSuccessimpl(obj) ? Result.m40constructorimpl(transform.invoke(obj)) : Result.m40constructorimpl(obj);
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable m43exceptionOrNullimpl = Result.m43exceptionOrNullimpl(obj);
        return m43exceptionOrNullimpl == null ? obj : Result.m40constructorimpl(transform.invoke(m43exceptionOrNullimpl));
    }
    ...
    private static final <T, R> Object runCatching(T t3, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m40constructorimpl(block.invoke(t3));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m40constructorimpl(createFailure(th));
        }

...
public final class TypesJVMKt {
    ...
    public static /* synthetic */ Type computeJavaType$default(KType kType, boolean z2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            z2 = false;
        }
    ...
    public static final String typeToString(Type type) {
        ...
        generateSequence = SequencesKt__SequencesKt.generateSequence(type, (Function1<? super Type, ? extends Type>) TypesJVMKt$typeToString$unwrap$1.INSTANCE);

...
final class LinesIterator implements Iterator<String>, KMappedMarker {
    ...
    public boolean hasNext() {
        ...
        for (int i12 = this.tokenStartIndex; i12 < length2; i12++) {
            char charAt = this.string.charAt(i12);
            if (charAt == '\n' || charAt == '\r') {
                i3 = (charAt == '\r' && (i10 = i12 + 1) < this.string.length() && this.string.charAt(i10) == '\n') ? 2 : 1;
                length = i12;
                this.state = 1;
    ...
    public String next() {
        ...
        this.state = 0;
        int i3 = this.delimiterStartIndex;
        int i10 = this.tokenStartIndex;
        this.tokenStartIndex = this.delimiterLength + i3;
        return this.string.subSequence(i10, i3).toString();
    }
}

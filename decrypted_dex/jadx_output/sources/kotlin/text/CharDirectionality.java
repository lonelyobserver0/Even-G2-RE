...
public final class CharDirectionality {
    ...
    public static final class Companion {
        ...
        public final CharDirectionality valueOf(int directionality) {
            ...
            throw new IllegalArgumentException(Xa.h.g(directionality, "Directionality #", " is not defined."));
        }
    ...
    private CharDirectionality(String str, int i3, int i10) {
        this.value = i10;
    }
    ...
    public static final Map directionalityMap_delegate$lambda$0() {
        ...
        LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.coerceAtLeast(MapsKt.mapCapacity(CollectionsKt.f(entries)), 16));

...
public class StringsKt__AppendableKt {
    ...
    public static <T> void appendElement(Appendable appendable, T t3, Function1<? super T, ? extends CharSequence> function1) {
    ...
    @SinceKotlin(version = "1.4")
    public static final <T extends Appendable> T appendRange(T t3, CharSequence value, int i3, int i10) {
        Intrinsics.checkNotNullParameter(t3, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        T t10 = (T) t3.append(value, i3, i10);

...
public final class Regex implements Serializable {
    ...
    public static /* synthetic */ MatchResult find$default(Regex regex, CharSequence charSequence, int i3, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            i3 = 0;
        }
    ...
    public static /* synthetic */ Sequence findAll$default(Regex regex, CharSequence charSequence, int i3, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            i3 = 0;
        }
    ...
    public static /* synthetic */ List split$default(Regex regex, CharSequence charSequence, int i3, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            i3 = 0;
        }
    ...
    public static /* synthetic */ Sequence splitToSequence$default(Regex regex, CharSequence charSequence, int i3, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            i3 = 0;
        }
    ...
    public final Sequence<MatchResult> findAll(final CharSequence input, final int startIndex) {
        ...
        if (startIndex < 0 || startIndex > input.length()) {
            StringBuilder u2 = Xa.h.u(startIndex, "Start index out of bounds: ", ", input length: ");
    ...
    public final String replace(CharSequence input, Function1<? super MatchResult, ? extends CharSequence> transform) {
        ...
        do {
            sb2.append(input, i3, find$default.getRange().getStart().intValue());

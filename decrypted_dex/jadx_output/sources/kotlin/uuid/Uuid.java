...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    public static final class Companion {
        ...
        public final Uuid m1505fromUByteArrayGBYM_sE(byte[] ubyteArray) {
        ...
        public final Uuid m1506fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public /* synthetic */ Uuid(long j, long j3, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j3);
    }
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m208boximpl(ULong.m214constructorimpl(getMostSignificantBits())), ULong.m208boximpl(ULong.m214constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1504toUByteArrayTcUX1vc() {
        return UByteArray.m111constructorimpl(toByteArray());
    }

    private Uuid(long j, long j3) {
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compareUnsigned(ULong.m214constructorimpl(j), ULong.m214constructorimpl(other.mostSignificantBits)) : Long.compareUnsigned(ULong.m214constructorimpl(this.leastSignificantBits), ULong.m214constructorimpl(other.leastSignificantBits));
    }
}

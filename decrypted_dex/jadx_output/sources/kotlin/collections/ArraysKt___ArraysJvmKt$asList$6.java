...
public final class ArraysKt___ArraysJvmKt$asList$6 extends AbstractList<Double> implements RandomAccess {
    ...
    public boolean contains(double element) {
        for (double d8 : this.$this_asList) {
            if (Double.doubleToLongBits(d8) == Double.doubleToLongBits(element)) {
                return true;
            }
        }
        return false;
    ...
    public int indexOf(double element) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            if (Double.doubleToLongBits(dArr[i3]) == Double.doubleToLongBits(element)) {
                return i3;
            }
        }
        return -1;

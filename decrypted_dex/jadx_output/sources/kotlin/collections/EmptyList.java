...
public final class EmptyList implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public List subList(int fromIndex, int toIndex) {
        ...
        throw new IndexOutOfBoundsException(h.o("fromIndex: ", fromIndex, toIndex, ", toIndex: "));
    }
    ...
    public void add(int i3, Void r22) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public Void get(int index) {
        throw new IndexOutOfBoundsException(u.s("Empty list doesn't contain element at index ", index, '.'));
    }
    ...
    public ListIterator listIterator(int index) {
        ...
        throw new IndexOutOfBoundsException(u.p(index, "Index: "));
    }
    ...
    public Void set(int i3, Void r22) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

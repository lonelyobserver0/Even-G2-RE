...
public class ArraysKt__ArraysJVMKt {
    public static final <T> T[] arrayOfNulls(T[] reference, int i3) {
    ...
    @SinceKotlin(version = "1.3")
    public static final void copyOfRangeToIndexCheck(int i3, int i10) {
        if (i3 > i10) {
            throw new IndexOutOfBoundsException(AbstractC1482f.e(i3, "toIndex (", i10, ") is greater than size (", ")."));
        }
    }

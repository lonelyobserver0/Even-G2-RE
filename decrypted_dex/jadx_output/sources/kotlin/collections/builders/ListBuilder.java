...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    public static final class BuilderSubList<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
        ...
        public static final class Itr<E> implements ListIterator<E>, KMutableListIterator {
            ...
            public Itr(BuilderSubList<E> list, int i3) {
        ...
        public BuilderSubList(E[] backing, int i3, int i10, BuilderSubList<E> builderSubList, ListBuilder<E> root) {
        ...
        private final void addAllInternal(int i3, Collection<? extends E> elements, int n10) {
            registerModification();
            BuilderSubList<E> builderSubList = this.parent;
            if (builderSubList != null) {
                builderSubList.addAllInternal(i3, elements, n10);
            } else {
                this.root.addAllInternal(i3, elements, n10);
            }
        ...
        private final void addAtInternal(int i3, E element) {
            ...
            BuilderSubList<E> builderSubList = this.parent;
            if (builderSubList != null) {
                builderSubList.addAtInternal(i3, element);
            } else {
                this.root.addAtInternal(i3, element);
            }
            this.backing = (E[]) ((ListBuilder) this.root).backing;
            this.length++;
        }
        ...
        private final E removeAtInternal(int i3) {
            ...
            BuilderSubList<E> builderSubList = this.parent;
            this.length--;
            return builderSubList != null ? builderSubList.removeAtInternal(i3) : (E) this.root.removeAtInternal(i3);
        }
        ...
        public int indexOf(Object element) {
            ...
            for (int i3 = 0; i3 < this.length; i3++) {
                if (Intrinsics.areEqual(this.backing[this.offset + i3], element)) {
                    return i3;
                }
            }
            return -1;
        ...
        public <T> T[] toArray(T[] array) {
            ...
            if (length >= i3) {
                E[] eArr = this.backing;
                int i10 = this.offset;
                ArraysKt___ArraysJvmKt.copyInto(eArr, array, 0, i10, i3 + i10);
                return (T[]) CollectionsKt.terminateCollectionToArray(this.length, array);
            }
            E[] eArr2 = this.backing;
            int i11 = this.offset;
            T[] tArr = (T[]) Arrays.copyOfRange(eArr2, i11, i3 + i11, array.getClass());
        ...
        public Object[] toArray() {
            ...
            E[] eArr = this.backing;
            int i3 = this.offset;
            return ArraysKt.copyOfRange(eArr, i3, this.length + i3);
        }
    }
    ...
    public final void addAllInternal(int i3, Collection<? extends E> elements, int n10) {
        registerModification();
        insertAtInternal(i3, n10);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void addAtInternal(int i3, E element) {
        registerModification();
        insertAtInternal(i3, 1);
        this.backing[i3] = element;
    }
    ...
    private final void insertAtInternal(int i3, int n10) {
        ensureExtraCapacity(n10);
        E[] eArr = this.backing;
        ArraysKt___ArraysJvmKt.copyInto(eArr, eArr, i3 + n10, i3, this.length);
        this.length += n10;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final E removeAtInternal(int i3) {
        registerModification();
        E[] eArr = this.backing;
        E e10 = eArr[i3];
        ArraysKt___ArraysJvmKt.copyInto(eArr, eArr, i3, i3 + 1, this.length);
    ...
    public final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        while (i3 < rangeLength) {
            int i11 = rangeOffset + i3;
            if (elements.contains(this.backing[i11]) == retain) {
                E[] eArr = this.backing;
                i3++;
                eArr[i10 + rangeOffset] = eArr[i11];
                i10++;
            } else {
                i3++;
            }
        ...
        E[] eArr2 = this.backing;
        ArraysKt___ArraysJvmKt.copyInto(eArr2, eArr2, rangeOffset + i10, rangeLength + rangeOffset, this.length);
    ...
    public int indexOf(Object element) {
        for (int i3 = 0; i3 < this.length; i3++) {
            if (Intrinsics.areEqual(this.backing[i3], element)) {
                return i3;
            }
        }
        return -1;
    ...
    public <T> T[] toArray(T[] array) {
        ...
        int i3 = this.length;
        if (length >= i3) {
            ArraysKt___ArraysJvmKt.copyInto(this.backing, array, 0, 0, i3);
            return (T[]) CollectionsKt.terminateCollectionToArray(this.length, array);
        }
    ...
    public ListBuilder(int i3) {
        this.backing = (E[]) ListBuilderKt.arrayOfUninitializedElements(i3);
    }
    ...
    public /* synthetic */ ListBuilder(int i3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? 10 : i3);
    }

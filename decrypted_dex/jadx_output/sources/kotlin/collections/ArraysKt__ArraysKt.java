        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            if (objArr != objArr2) {
                ...
                if ((objArr instanceof Object[]) && (objArr2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m610contentEqualskV0jMPg(((UByteArray) objArr).getStorage(), ((UByteArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UShortArray) && (objArr2 instanceof UShortArray)) {
                    if (!UArraysKt.m608contentEqualsFGO6Aew(((UShortArray) objArr).getStorage(), ((UShortArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof UIntArray) && (objArr2 instanceof UIntArray)) {
                    if (!UArraysKt.m609contentEqualsKJPZfPQ(((UIntArray) objArr).getStorage(), ((UIntArray) objArr2).getStorage())) {
                        return false;
                    }
                } else if ((objArr instanceof ULongArray) && (objArr2 instanceof ULongArray)) {
                    if (!UArraysKt.m611contentEqualslec5QzE(((ULongArray) objArr).getStorage(), ((ULongArray) objArr2).getStorage())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb2, List<Object[]> list) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            if (objArr == 0) {
                ...
                sb2.append(UArraysKt.m616contentToString2csIQuQ(((UByteArray) objArr).getStorage()));
            } else if (objArr instanceof UShortArray) {
                sb2.append(UArraysKt.m618contentToStringd6D3K8(((UShortArray) objArr).getStorage()));
            } else if (objArr instanceof UIntArray) {
                sb2.append(UArraysKt.m617contentToStringXUkPCBk(((UIntArray) objArr).getStorage()));
            } else if (objArr instanceof ULongArray) {
                sb2.append(UArraysKt.m619contentToStringuLth9ew(((ULongArray) objArr).getStorage()));
            } else {

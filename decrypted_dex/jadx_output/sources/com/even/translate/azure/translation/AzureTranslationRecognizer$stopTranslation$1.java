...
@DebugMetadata(c = "com.even.translate.azure.translation.AzureTranslationRecognizer$stopTranslation$1", f = "AzureTranslationRecognizer.kt", i = {}, l = {210}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /home/loneobs/Code/Even/RE/even-apks/base/decrypted_dex/classes3.dex */
public final class AzureTranslationRecognizer$stopTranslation$1 extends SuspendLambda implements Function2<I, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ AzureTranslationRecognizer this$0;

    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"LQb/I;", "Ljava/lang/Void;", "<anonymous>", "(LQb/I;)Ljava/lang/Void;"}, k = 3, mv = {2, 1, 0})
    @DebugMetadata(c = "com.even.translate.azure.translation.AzureTranslationRecognizer$stopTranslation$1$1", f = "AzureTranslationRecognizer.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.even.translate.azure.translation.AzureTranslationRecognizer$stopTranslation$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AzureTranslationRecognizer$stopTranslation$1(AzureTranslationRecognizer azureTranslationRecognizer, Continuation<? super AzureTranslationRecognizer$stopTranslation$1> continuation) {
        super(2, continuation);
        this.this$0 = azureTranslationRecognizer;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AzureTranslationRecognizer$stopTranslation$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(I i3, Continuation<? super Unit> continuation) {
        return ((AzureTranslationRecognizer$stopTranslation$1) create(i3, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i3 == 0) {
                ResultKt.throwOnFailure(obj);
                this.this$0.setState(AzureRecognizerState.STOPPING);
                c cVar = W.f5839b;
            ...
            this.this$0.recognizer = null;
            this.this$0.setState(AzureRecognizerState.IDLE);
            str2 = this.this$0.tag;
            R2.c.d(str2, StubApp.getString2("6878"));
            return Unit.INSTANCE;
        } catch (Exception e10) {
            str = this.this$0.tag;
            String string2 = StubApp.getString2(6879);
            R2.c.c(str, string2 + e10);
            this.this$0.setState(AzureRecognizerState.ERROR);
            throw new AzureRecognizerError.StopTranslationError(E1.a.i(string2, e10));
        }
    }
}

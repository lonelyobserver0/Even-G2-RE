...
@DebugMetadata(c = "com.even.translate.azure.translation.AzureTranslationRecognizer$resumeTranslation$1", f = "AzureTranslationRecognizer.kt", i = {}, l = {186}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: /home/loneobs/Code/Even/RE/even-apks/base/decrypted_dex/classes3.dex */
public final class AzureTranslationRecognizer$resumeTranslation$1 extends SuspendLambda implements Function2<I, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ AzureTranslationRecognizer this$0;

    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u0004\u0018\u00010\u0001*\u00020\u0000H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"LQb/I;", "Ljava/lang/Void;", "<anonymous>", "(LQb/I;)Ljava/lang/Void;"}, k = 3, mv = {2, 1, 0})
    @DebugMetadata(c = "com.even.translate.azure.translation.AzureTranslationRecognizer$resumeTranslation$1$1", f = "AzureTranslationRecognizer.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.even.translate.azure.translation.AzureTranslationRecognizer$resumeTranslation$1$1, reason: invalid class name */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AzureTranslationRecognizer$resumeTranslation$1(AzureTranslationRecognizer azureTranslationRecognizer, Continuation<? super AzureTranslationRecognizer$resumeTranslation$1> continuation) {
        super(2, continuation);
        this.this$0 = azureTranslationRecognizer;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AzureTranslationRecognizer$resumeTranslation$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(I i3, Continuation<? super Unit> continuation) {
        return ((AzureTranslationRecognizer$resumeTranslation$1) create(i3, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            R2.c.d(str2, StubApp.getString2("6873"));
            ...
            throw new AzureRecognizerError.ResumeTranslationError(E1.a.i(string2, e10));
        }
    }
}

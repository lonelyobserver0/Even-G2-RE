...
public class TypeNameIdResolver extends TypeIdResolverBase {
    ...
    public static TypeNameIdResolver construct(MapperConfig<?> mapperConfig, JavaType javaType, Collection<NamedType> collection, boolean z2, boolean z10) {
        HashMap hashMap;
    ...
    public String toString() {
        return String.format(StubApp.getString2(10987), getClass().getName(), this._idToType);
    }

...
public class BuilderBasedDeserializer extends BeanDeserializerBase {
    ...
    public BuilderBasedDeserializer(BeanDeserializerBuilder beanDeserializerBuilder, BeanDescription beanDescription, JavaType javaType, BeanPropertyMap beanPropertyMap, Map<String, SettableBeanProperty> map, Set<String> set, boolean z2, Set<String> set2, boolean z10) {
        super(beanDeserializerBuilder, beanDescription, beanPropertyMap, map, set, z2, set2, z10);
        this._targetType = javaType;
        this._buildMethod = beanDeserializerBuilder.getBuildMethod();
        if (this._objectIdReader == null) {
            return;
        }
        throw new IllegalArgumentException(StubApp.getString2(10634) + beanDescription.getType() + StubApp.getString2(74));
    }
    ...
    public Object deserializeUsingPropertyBasedWithExternalTypeId(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        return deserializationContext.reportBadDefinition(javaType, String.format(StubApp.getString2(10637), javaType));
    }
    ...
    public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj) throws IOException {
        ...
        if (handledType.isAssignableFrom(cls)) {
            return deserializationContext.reportBadDefinition(javaType, String.format(StubApp.getString2(10635), javaType, handledType.getName()));
        }
        return deserializationContext.reportBadDefinition(javaType, String.format(StubApp.getString2(10636), javaType, cls.getName()));
    }

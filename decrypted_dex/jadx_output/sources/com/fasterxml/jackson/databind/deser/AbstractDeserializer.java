...
public class AbstractDeserializer extends JsonDeserializer<Object> implements ContextualDeserializer, Serializable {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws JsonMappingException {
        ...
        deserializationContext.objectIdResolverInstance(member, findObjectIdInfo);
        ...
        if (generatorType == ObjectIdGenerators$PropertyGenerator.class) {
            ...
            if (settableBeanProperty2 == null) {
                deserializationContext.reportBadDefinition(this._baseType, AbstractC1482f.i("Invalid Object Id definition for ", ClassUtil.nameOf(handledType()), ": cannot find property with name ", ClassUtil.name(propertyName)));
            }
        ...
        return new AbstractDeserializer(this, ObjectIdReader.construct(javaType, findObjectReferenceInfo.getPropertyName(), objectIdGeneratorInstance, deserializationContext.findRootValueDeserializer(javaType), settableBeanProperty, null), null);
    }

...
public class BeanAsArrayBuilderDeserializer extends BeanDeserializerBase {
    ...
    public Object _deserializeFromNonArray(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        return deserializationContext.handleUnexpectedToken(getValueType(deserializationContext), jsonParser.currentToken(), jsonParser, StubApp.getString2(10654), this._beanType.getRawClass().getName(), jsonParser.currentToken());
    }
        ...
        while (true) {
            ...
            if (i3 == length) {
                if (!this._ignoreAllUnknown && deserializationContext.isEnabled(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES)) {
                    deserializationContext.reportWrongTokenException(this, jsonToken, StubApp.getString2(10655), Integer.valueOf(length));
                }
                    ...
                    if (findCreatorProperty == null) {
                        ...
                        try {
                            ...
                            if (obj.getClass() != this._beanType.getRawClass()) {
                                ...
                                return deserializationContext.reportBadDefinition(javaType, AbstractC1482f.i(StubApp.getString2(10656), ClassUtil.getTypeDescription(javaType), StubApp.getString2(10657), obj.getClass().getName()));
                            }
                        } catch (Exception e11) {
    ...
    public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        while (jsonParser.nextToken() != JsonToken.END_ARRAY) {
            if (i3 == length) {
                if (!this._ignoreAllUnknown && deserializationContext.isEnabled(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES)) {
                    deserializationContext.reportInputMismatch(handledType(), StubApp.getString2(10658), Integer.valueOf(length));
                }
                while (jsonParser.nextToken() != JsonToken.END_ARRAY) {
                    jsonParser.skipChildren();
                }

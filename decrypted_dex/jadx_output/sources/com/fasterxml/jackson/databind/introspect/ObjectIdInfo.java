...
public class ObjectIdInfo {
    ...
    public String toString() {
        return StubApp.getString2(10812) + this._propertyName + StubApp.getString2(1556) + ClassUtil.nameOf(this._scope) + StubApp.getString2(10813) + ClassUtil.nameOf(this._generator) + StubApp.getString2(10814) + this._alwaysAsId;
    }

    public ObjectIdInfo withAlwaysAsId(boolean z2) {
        return this._alwaysAsId == z2 ? this : new ObjectIdInfo(this._propertyName, this._scope, this._generator, z2, this._resolver);
    }

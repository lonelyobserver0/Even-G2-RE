...
public class InetSocketAddressSerializer extends StdScalarSerializer<InetSocketAddress> {
    ...
    public void serialize(InetSocketAddress inetSocketAddress, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        if (indexOf >= 0) {
            if (indexOf == 0) {
                if (address instanceof Inet6Address) {
                    substring = StubApp.getString2(1557) + hostName.substring(1) + StubApp.getString2(511);
                } else {
        ...
        StringBuilder n10 = AbstractC1482f.n(hostName, StubApp.getString2(478));
        n10.append(inetSocketAddress.getPort());
        jsonGenerator.writeString(n10.toString());
    }

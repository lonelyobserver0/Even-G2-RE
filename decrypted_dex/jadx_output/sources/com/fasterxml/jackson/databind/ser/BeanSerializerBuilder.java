...
public class BeanSerializerBuilder {
    ...
    public JsonSerializer<?> build() {
        ...
        throw new IllegalStateException(String.format(StubApp.getString2(10993), Integer.valueOf(this._properties.size()), Integer.valueOf(this._filteredProperties.length)));
    }
    ...
    public void setFilteredProperties(BeanPropertyWriter[] beanPropertyWriterArr) {
        if (beanPropertyWriterArr == null || beanPropertyWriterArr.length == this._properties.size()) {
            ...
            throw new IllegalArgumentException(String.format(StubApp.getString2(10994), Integer.valueOf(beanPropertyWriterArr.length), Integer.valueOf(this._properties.size())));
        }
    }
    ...
    public void setTypeId(AnnotatedMember annotatedMember) {
        ...
        throw new IllegalArgumentException(StubApp.getString2(10995) + this._typeId + StubApp.getString2(3542) + annotatedMember);
    }
}

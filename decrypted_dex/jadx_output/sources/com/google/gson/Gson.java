...
public final class Gson {
    ...
    */
    ...
    public Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z2, boolean z10, boolean z11, boolean z12, FormattingStyle formattingStyle, Strictness strictness, boolean z13, boolean z14, LongSerializationPolicy longSerializationPolicy, String str, int i3, int i10, List<TypeAdapterFactory> list, List<TypeAdapterFactory> list2, List<TypeAdapterFactory> list3, ToNumberStrategy toNumberStrategy, ToNumberStrategy toNumberStrategy2, List<ReflectionAccessFilter> list4) {

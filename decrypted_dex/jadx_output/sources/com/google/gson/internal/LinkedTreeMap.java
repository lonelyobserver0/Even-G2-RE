...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public Node<K, V> find(K k3, boolean z2) {
        ...
        if (node2 != null) {
            ...
            while (true) {
                i3 = comparable != null ? comparable.compareTo(node2.key) : comparator.compare(k3, node2.key);
                if (i3 == 0) {
                    return node2;
                }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(boolean z2, Node<K, V> node, K k3, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k3;
            this.allowNullValue = z2;
            this.height = 1;

...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    public static final TypeAdapterFactory DEFAULT_STYLE_FACTORY = new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.DefaultDateTypeAdapter.1
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            ...
            int i3 = 2;
            return new DefaultDateTypeAdapter(DateType.DATE, i3, i3);
        }
    ...
    public static abstract class DateType<T extends Date> {
        ...
        public final TypeAdapterFactory createAdapterFactory(int i3, int i10) {
            return createFactory(new DefaultDateTypeAdapter<>(this, i3, i10));
        }
    }
        ...
        synchronized (this.dateFormats) {
            try {
                ...
                try {
                    ...
                    StringBuilder l9 = b.l("Failed parsing '", nextString, "' as Date; at path ");
    ...
    private DefaultDateTypeAdapter(DateType<T> dateType, int i3, int i10) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        Objects.requireNonNull(dateType);
        this.dateType = dateType;
        ...
        if (JavaVersion.isJava9OrLater()) {
            arrayList.add(PreJava9DateFormatProvider.getUsDateTimeFormat(i3, i10));
        }
    }
}

                ...
                try {
                    ...
                    return new UnsafeAllocator() { // from class: com.google.gson.internal.UnsafeAllocator.4
                        ...
                        public <T> T newInstance(Class<T> cls2) {
                            throw new UnsupportedOperationException(h.p("Cannot allocate ", cls2, ". Usage of JDK sun.misc.Unsafe is enabled, but it could not be used. Make sure your runtime is configured correctly."));
                        }
                    };
                }

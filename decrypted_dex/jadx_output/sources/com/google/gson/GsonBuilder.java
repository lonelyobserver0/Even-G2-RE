...
public final class GsonBuilder {
    ...
    private static void addTypeAdaptersForDate(String str, int i3, int i10, List<TypeAdapterFactory> list) {
    ...
    private static int checkDateFormatStyle(int i3) {
        if (i3 < 0 || i3 > 3) {
            throw new IllegalArgumentException(u.p(i3, "Invalid style: "));
        }
        return i3;
    }
    ...
    public GsonBuilder setDateFormat(String str) {
        if (str != null) {
            try {
                ...
                throw new IllegalArgumentException(a.k("The date pattern '", str, "' is not valid"), e10);
            }
        }

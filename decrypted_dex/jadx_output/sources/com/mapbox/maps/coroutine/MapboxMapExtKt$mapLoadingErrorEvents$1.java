...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u0002*\b\u0012\u0004\u0012\u00020\u00010\u0000H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"LSb/v;", "Lcom/mapbox/maps/MapLoadingError;", "", "<anonymous>", "(LSb/v;)V"}, k = 3, mv = {1, 7, 1})
@DebugMetadata(c = "com.mapbox.maps.coroutine.MapboxMapExtKt$mapLoadingErrorEvents$1", f = "MapboxMapExt.kt", i = {}, l = {276}, m = "invokeSuspend", n = {}, s = {})
...
public final class MapboxMapExtKt$mapLoadingErrorEvents$1 extends SuspendLambda implements Function2<v, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(v vVar, Continuation<? super Unit> continuation) {
        return ((MapboxMapExtKt$mapLoadingErrorEvents$1) create(vVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i3 == 0) {
            ...
            MapLoadingErrorCallback mapLoadingErrorCallback = new MapLoadingErrorCallback() { // from class: com.mapbox.maps.coroutine.b
                ...
                public final void run(MapLoadingError mapLoadingError) {
                    Oc.a.T(v.this, mapLoadingError);
                }
            };
            u uVar = (u) vVar;
            uVar.getClass();
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(NativeObserver.subscribeMapLoadingError$default(nativeObserver, mapLoadingErrorCallback, new MapboxMapExtKt$mapLoadingErrorEvents$1$cancelable$2(uVar), null, 4, null));
            this.label = 1;

...
public final class RouteLineViewRenderRouteDrawDataValue extends RouteLineViewWithStyleIdValue {
    ...
    public RouteLineViewRenderRouteDrawDataValue(String str, RouteLineViewExpectedInput input) {
        super(StubApp.getString2(14803), str);

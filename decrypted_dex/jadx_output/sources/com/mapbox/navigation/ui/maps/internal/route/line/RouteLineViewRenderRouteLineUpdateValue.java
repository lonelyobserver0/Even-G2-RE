...
public final class RouteLineViewRenderRouteLineUpdateValue extends RouteLineViewWithStyleIdValue {
    ...
    public RouteLineViewRenderRouteLineUpdateValue(String str, RouteLineViewExpectedInput input) {
        super(StubApp.getString2(14811), str);

...
public class KeywordRecognitionEventArgs extends RecognitionEventArgs {
    ...
    public String toString() {
        return StubApp.getString2(15708) + getSessionId() + StubApp.getString2(15709) + this.result.getResultId() + StubApp.getString2(15710) + this.result.getReason() + StubApp.getString2(15711) + this.result.getText() + StubApp.getString2(6919);
    }

    public KeywordRecognitionEventArgs(long j, boolean z2) {
        super(j);
        storeEventData(z2);
    }
}

...
public class QuicOptions {
    ...
    public static class Builder {
        ...
        @Experimental
        public Builder closeSessionsOnIpChange(boolean z2) {
            this.mCloseSessionsOnIpChange = Boolean.valueOf(z2);
            return this;
        }

        @Experimental
        public Builder delayJobsWithAvailableSpdySession(boolean z2) {
            this.mDelayJobsWithAvailableSpdySession = Boolean.valueOf(z2);
            return this;
        }

        @Experimental
        public Builder enableTlsZeroRtt(boolean z2) {
            this.mEnableTlsZeroRtt = Boolean.valueOf(z2);
            return this;
        }

        @Experimental
        public Builder goawaySessionsOnIpChange(boolean z2) {
            this.mGoawaySessionsOnIpChange = Boolean.valueOf(z2);
            return this;
        }

        @Experimental
        public Builder increaseBrokenServicePeriodExponentially(boolean z2) {
            this.mIncreaseBrokenServicePeriodExponentially = Boolean.valueOf(z2);
            return this;
        }

        @Experimental
        public Builder retryWithoutAltSvcOnQuicErrors(boolean z2) {
            this.mRetryWithoutAltSvcOnQuicErrors = Boolean.valueOf(z2);
            return this;
        }
        ...
        public Builder setInMemoryServerConfigsCacheSize(int i3) {
            this.mInMemoryServerConfigsCacheSize = Integer.valueOf(i3);
            return this;
        }

    ...
    public InputDecryptorProvider build(final char[] cArr) {
        return new InputDecryptorProvider() { // from class: org.bouncycastle.pkcs.jcajce.JcePKCSPBEInputDecryptorProviderBuilder.1
            ...
            public InputDecryptor get(AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
                ...
                String string2 = StubApp.getString2(33905);
                ...
                try {
                    if (algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
                        ...
                        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) pBES2Parameters.getKeyDerivationFunc().getAlgorithm())) {
                            ...
                            generateSecret = createSecretKeyFactory.generateSecret(pBKDF2Params.isDefaultPrf() ? new PBEKeySpec(cArr, pBKDF2Params.getSalt(), pBKDF2Params.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.this.keySizeProvider.getKeySize(algorithmIdentifier2)) : new PBKDF2KeySpec(cArr, pBKDF2Params.getSalt(), pBKDF2Params.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.this.keySizeProvider.getKeySize(algorithmIdentifier2), pBKDF2Params.getPrf()));
                        }
                        ...
                        if (!algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC) && !algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC)) {
                            throw new OperatorCreationException(string2 + algorithm + StubApp.getString2("11660"));
                        }
                    ...
                    throw new OperatorCreationException(u.r(e10, new StringBuilder(StubApp.getString2(33866))), e10);
                }
            }
        };
    }

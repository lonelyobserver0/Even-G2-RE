...
public class JcePKCSPBEOutputEncryptorBuilder {
    ...
    private SecretKey simplifyPbeKey(SecretKey secretKey) {
        if (this.algorithmNameFinder.hasAlgorithmName(this.keyEncAlgorithm)) {
            ...
            if (algorithmName.indexOf(string2) >= 0) {
                return new SecretKeySpec(secretKey.getEncoded(), string2);
            }
        }
        return secretKey;
    }
        ...
        try {
            if (isPKCS12(this.algorithm)) {
                ...
                if (!this.algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBES2)) {
                    throw new OperatorCreationException(StubApp.getString2("33906"));
                }
                ...
                if (aSN1ObjectIdentifier.equals((ASN1Primitive) pBKDFConfig.getAlgorithm())) {
                    ...
                    cArr2 = cArr;
                    SecretKey generateSecret = this.helper.createSecretKeyFactory(StubApp.getString2("32169")).generateSecret(new ScryptKeySpec(cArr2, bArr2, scryptConfig.getCostParameter(), scryptConfig.getBlockSize(), scryptConfig.getParallelizationParameter(), this.keySizeProvider.getKeySize(new AlgorithmIdentifier(this.keyEncAlgorithm))));
            ...
            throw new OperatorCreationException(u.r(e10, new StringBuilder(StubApp.getString2(33907))), e10);
        }
    }

    public JcePKCSPBEOutputEncryptorBuilder setIterationCount(int i3) {
        if (this.pbkdf != null) {
            throw new IllegalStateException(StubApp.getString2(33908));
        }
        this.iterationCount = i3;
        this.pbkdfBuilder.withIterationCount(i3);
        return this;
    }
    ...
    public JcePKCSPBEOutputEncryptorBuilder setPRF(AlgorithmIdentifier algorithmIdentifier) {
        if (this.pbkdf != null) {
            throw new IllegalStateException(StubApp.getString2(33909));
        }

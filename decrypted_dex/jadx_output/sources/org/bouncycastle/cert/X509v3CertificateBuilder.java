...
public class X509v3CertificateBuilder {
    ...
    public X509CertificateHolder build(ContentSigner contentSigner) {
        ...
        try {
            ...
            throw new IllegalArgumentException(StubApp.getString2(28008));
        }
    }
    ...
    public X509v3CertificateBuilder copyAndAddExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z2, X509CertificateHolder x509CertificateHolder) {
        ...
        if (extension == null) {
            throw new NullPointerException(a.f(StubApp.getString2(27782), aSN1ObjectIdentifier, StubApp.getString2(27784)));
        }
    ...
    public X509v3CertificateBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z2, ASN1Encodable aSN1Encodable) throws CertIOException {
        try {
            this.extGenerator = CertUtils.doReplaceExtension(this.extGenerator, new Extension(aSN1ObjectIdentifier, z2, aSN1Encodable.toASN1Primitive().getEncoded(StubApp.getString2("26791"))));
            return this;
        } catch (IOException e10) {
            throw new CertIOException(u.q(e10, new StringBuilder(StubApp.getString2(28004))), e10);
        }
    ...
    public X509v3CertificateBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z2, byte[] bArr) throws CertIOException {
        this.extGenerator = CertUtils.doReplaceExtension(this.extGenerator, new Extension(aSN1ObjectIdentifier, z2, bArr));
        return this;
    }

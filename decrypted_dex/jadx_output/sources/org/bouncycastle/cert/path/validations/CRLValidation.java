...
public class CRLValidation implements CertPathValidation {
    ...
    public void validate(CertPathValidationContext certPathValidationContext, X509CertificateHolder x509CertificateHolder) throws CertPathValidationException {
        ...
        if (matches.isEmpty()) {
            throw new CertPathValidationException(StubApp.getString2(28120) + this.workingIssuerName + StubApp.getString2(6390));
        }
        Iterator it = matches.iterator();
        while (it.hasNext()) {
            if (((X509CRLHolder) it.next()).getRevokedCertificate(x509CertificateHolder.getSerialNumber()) != null) {
                throw new CertPathValidationException(StubApp.getString2(28119));
            }
        }

...
public class X509v2CRLBuilder {
    ...
    public X509v2CRLBuilder addCRLEntry(BigInteger bigInteger, Date date, int i3) {
    ...
    public X509v2CRLBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z2, ASN1Encodable aSN1Encodable) throws CertIOException {
        try {
    ...
    public X509v2CRLBuilder addCRLEntry(BigInteger bigInteger, Date date, int i3, Date date2) {
    ...
    public X509v2CRLBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z2, byte[] bArr) throws CertIOException {

...
public class CertificateRequestMessageBuilder {
    ...
    public CertificateRequestMessageBuilder setProofOfPossessionSubsequentMessage(int i3, SubsequentMessage subsequentMessage) {
        if (this.popSigner != null || this.popRaVerified != null || this.agreeMAC != null) {
            throw new IllegalStateException(StubApp.getString2(28032));
        }
        if (i3 != 2 && i3 != 3) {
            throw new IllegalArgumentException(StubApp.getString2(28033));
        }
        this.popoType = i3;

...
public class JceCRMFEncryptorBuilder {
    ...
    public class CRMFOutputEncryptor implements OutputEncryptor {
        ...
        public CRMFOutputEncryptor(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i3, SecureRandom secureRandom) throws CRMFException {
            KeyGenerator createKeyGenerator = JceCRMFEncryptorBuilder.this.helper.createKeyGenerator(aSN1ObjectIdentifier);
            secureRandom = secureRandom == null ? new SecureRandom() : secureRandom;
            i3 = i3 < 0 ? JceCRMFEncryptorBuilder.KEY_SIZE_PROVIDER.getKeySize(aSN1ObjectIdentifier) : i3;
            if (i3 < 0) {
                createKeyGenerator.init(secureRandom);
            } else {
                createKeyGenerator.init(i3, secureRandom);
            }
            ...
            try {
                ...
                throw new CRMFException(a.h(e10, new StringBuilder(StubApp.getString2(28076))), e10);
            }
        }
    ...
    public JceCRMFEncryptorBuilder(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i3) {

    ...
    private PemObject generate(PrivateKeyInfo privateKeyInfo, OutputEncryptor outputEncryptor) throws PemGenerationException {
        try {
            ...
            if (outputEncryptor == null) {
                return new PemObject(StubApp.getString2("33620"), encoded);
            }
            ...
            outputStream.close();
            return new PemObject(StubApp.getString2("33624"), new EncryptedPrivateKeyInfo(outputEncryptor.getAlgorithmIdentifier(), byteArrayOutputStream.toByteArray()).getEncoded());
        } catch (IOException e10) {
            throw new PemGenerationException(u.q(e10, new StringBuilder(StubApp.getString2(33652))), e10);
        }
    }
}

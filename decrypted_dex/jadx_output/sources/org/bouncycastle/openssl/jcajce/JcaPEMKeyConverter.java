...
public class JcaPEMKeyConverter {
    ...
    static {
        ...
        algorithms = hashMap;
        hashMap.put(X9ObjectIdentifiers.id_ecPublicKey, StubApp.getString2(28163));
        hashMap.put(PKCSObjectIdentifiers.rsaEncryption, StubApp.getString2(24659));
        hashMap.put(X9ObjectIdentifiers.id_dsa, StubApp.getString2(28060));
    }
    ...
    private KeyFactory getKeyFactory(AlgorithmIdentifier algorithmIdentifier) throws NoSuchAlgorithmException, NoSuchProviderException {
        ...
        try {
            ...
            if (str.equals(StubApp.getString2(28163))) {
                return this.helper.createKeyFactory(StubApp.getString2(4707));
            }
            throw e10;
        }
    }
    ...
    public KeyPair getKeyPair(PEMKeyPair pEMKeyPair) throws PEMException {
        try {
            ...
            throw new PEMException(u.r(e10, new StringBuilder(StubApp.getString2(33673))), e10);
        }
    }

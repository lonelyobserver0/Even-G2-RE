        ...
        try {
            ...
            if (PEMUtilities.isPKCS5Scheme2(this.algOID)) {
                ...
                if (!PEMUtilities.isPKCS12(this.algOID)) {
                    throw new OperatorCreationException(StubApp.getString2(33681) + this.algOID, null);
                }
            ...
            throw new OperatorCreationException(this.algOID + StubApp.getString2(33679) + e13.getMessage(), e13);
        }
    }

    public JceOpenSSLPKCS8EncryptorBuilder setIterationCount(int i3) {

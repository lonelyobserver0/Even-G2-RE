...
public class JceKTSKeyWrapper extends AsymmetricKeyWrapper {
    ...
    public JceKTSKeyWrapper(PublicKey publicKey, String str, int i3, byte[] bArr, byte[] bArr2) {
        super(new AlgorithmIdentifier(PKCSObjectIdentifiers.id_rsa_KEM, new GenericHybridParameters(new AlgorithmIdentifier(ISOIECObjectIdentifiers.id_kem_rsa, new RsaKemParameters(new AlgorithmIdentifier(X9ObjectIdentifiers.id_kdf_kdf3, new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256)), (i3 + 7) / 8)), JceSymmetricKeyWrapper.determineKeyEncAlg(str, i3))));
    ...
    public byte[] generateWrappedKey(GenericKey genericKey) throws OperatorException {
        ...
        try {
            ...
            throw new OperatorException(u.r(e10, new StringBuilder(StubApp.getString2(33868))), e10);
        }
    }
    ...
    public JceKTSKeyWrapper(X509Certificate x509Certificate, String str, int i3, byte[] bArr, byte[] bArr2) {

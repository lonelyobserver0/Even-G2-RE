...
public class SecT193R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R2Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27260))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27261))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27262)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawXCoord()).f19268x, 0, jArr, i11);
            Nat256.copy64(((SecT193FieldElement) eCPoint.getRawYCoord()).f19268x, 0, jArr, i11 + 4);
            i11 += 8;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT193R2Curve.1
            ...
            public ECPoint lookup(int i13) {
                ...
                for (int i15 = 0; i15 < i10; i15++) {
                    ...
                    for (int i16 = 0; i16 < 4; i16++) {
                        ...
                        create642[i16] = create642[i16] ^ (jArr2[(i14 + 4) + i16] & j);
                    }
                    i14 += 8;
                }
            ...
            public ECPoint lookupVar(int i13) {
                ...
                for (int i15 = 0; i15 < 4; i15++) {
                    long j = create64[i15];
                    long[] jArr2 = jArr;
                    create64[i15] = j ^ jArr2[i14 + i15];
                    create642[i15] = create642[i15] ^ jArr2[(4 + i14) + i15];
                }
                return createPoint(create64, create642);
            }
        };

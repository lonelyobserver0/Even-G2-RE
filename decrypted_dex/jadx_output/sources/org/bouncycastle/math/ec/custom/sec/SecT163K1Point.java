...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement v2 = a.v(eCFieldElement2, multiply, eCFieldElement3);
        if (v2.isZero()) {
            return new SecT163K1Point(curve, v2, curve.getB());
        }
        ECFieldElement square = v2.square();
        ECFieldElement multiply2 = isOne ? v2 : v2.multiply(eCFieldElement3);
        ECFieldElement square2 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, square, square2.add(v2).add(eCFieldElement3).multiply(square2).add(square), new ECFieldElement[]{multiply2});
    }

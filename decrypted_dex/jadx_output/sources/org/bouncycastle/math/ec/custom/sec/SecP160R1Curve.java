...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f19212q = SecP160R1FieldElement.f19216Q;
    ...
    public SecP160R1Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27318))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27319))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27320)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawXCoord()).f19217x, 0, iArr, i11);
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawYCoord()).f19217x, 0, iArr, i11 + 5);
            i11 += 10;
        }

...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f19228q = SecP192R1FieldElement.f19232Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27339))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27340))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27341)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f19233x, 0, iArr, i11);
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f19233x, 0, iArr, i11 + 6);
            i11 += 12;
        }

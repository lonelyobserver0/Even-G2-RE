...
public class SecT193R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (v2.isZero()) {
            return new SecT193R2Point(curve, v2, curve.getB().sqrt());
        }
        ...
        return new SecT193R2Point(curve, square2, eCFieldElement.squarePlusProduct(v2, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }

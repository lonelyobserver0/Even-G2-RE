...
public class SecP256R1Field {
    ...
    private static final long f19251M = 4294967295L;

    /* renamed from: P7, reason: collision with root package name */
    private static final int f19253P7 = -1;
    private static final int PExt15s1 = Integer.MAX_VALUE;

    /* renamed from: P, reason: collision with root package name */
    static final int[] f19252P = {-1, -1, -1, 0, 0, 0, 1, -1};
    private static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f19252P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f19252P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j12 = ((iArr[3] & 4294967295L) - 1) + j3;
        iArr[3] = (int) j12;
        long j13 = j12 >> 32;
        if (j13 != 0) {
        ...
        long j16 = ((iArr[6] & 4294967295L) - 1) + j13;
        iArr[6] = (int) j16;
        iArr[7] = (int) ((4294967295L & iArr[7]) + 1 + (j16 >> 32));
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f19252P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f19252P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f19252P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        iArr2[0] = (int) j24;
        long j25 = ((((iArr[1] & 4294967295L) + j17) - j20) - j22) + (j24 >> 32);
        iArr2[1] = (int) j25;
        long j26 = (((iArr[2] & 4294967295L) + j18) - j21) + (j25 >> 32);
        iArr2[2] = (int) j26;
        long j27 = ((((iArr[3] & 4294967295L) + (j19 << 1)) + j23) - j22) + (j26 >> 32);
        iArr2[3] = (int) j27;
        long j28 = ((((iArr[4] & 4294967295L) + (j20 << 1)) + j13) - j17) + (j27 >> 32);
        iArr2[4] = (int) j28;
        long j29 = (((iArr[5] & 4294967295L) + (j21 << 1)) - j18) + (j28 >> 32);
        iArr2[5] = (int) j29;
        long j30 = (iArr[6] & 4294967295L) + (j22 << 1) + j23 + (j29 >> 32);
        iArr2[6] = (int) j30;
        long j31 = (((((iArr[7] & 4294967295L) + (j14 << 1)) + j15) - j18) - j20) + (j30 >> 32);
        iArr2[7] = (int) j31;
    ...
    public static void reduce32(int i3, int[] iArr) {
        ...
        if (i3 != 0) {
            ...
            long j14 = ((iArr[3] & 4294967295L) - j3) + j11;
            iArr[3] = (int) j14;
            long j15 = j14 >> 32;
            if (j15 != 0) {
            ...
            long j18 = ((iArr[6] & 4294967295L) - j3) + j15;
            iArr[6] = (int) j18;
            long j19 = (4294967295L & iArr[7]) + j3 + (j18 >> 32);
            iArr[7] = (int) j19;
            j = j19 >> 32;
        } else {
            j = 0;
        }
        if (j != 0 || (iArr[7] == -1 && Nat256.gte(iArr, f19252P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f19252P))) {
            addPInvTo(iArr2);
        }
    }

...
public class SecT131R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R2Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27233))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27234))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27235)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawXCoord()).f19266x, 0, jArr, i11);
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawYCoord()).f19266x, 0, jArr, i11 + 3);
            i11 += 6;
        }

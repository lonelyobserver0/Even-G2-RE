...
public class SecT283R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT283R1Curve() {
        ...
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27275))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27276)));

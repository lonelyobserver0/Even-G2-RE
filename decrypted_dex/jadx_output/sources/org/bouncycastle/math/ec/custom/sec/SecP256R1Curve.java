...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f19250q = SecP256R1FieldElement.f19254Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27201))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27202))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27203)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f19255x, 0, iArr, i11);
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f19255x, 0, iArr, i11 + 8);
            i11 += 16;
        }

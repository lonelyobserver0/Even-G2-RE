...
public class SecT239K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT239K1Curve() {
        ...
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27271)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawXCoord()).f19270x, 0, jArr, i11);
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawYCoord()).f19270x, 0, jArr, i11 + 4);
            i11 += 8;
        }

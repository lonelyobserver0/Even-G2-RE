...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f19238x;

    /* renamed from: Q, reason: collision with root package name */
    public static final BigInteger f19237Q = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27174)));
    private static final int[] PRECOMP_POW2 = {868209154, -587542221, 579297866, -1014948952, -1470801668, 514782679, -1897982644};

    public SecP224K1FieldElement() {
        this.f19238x = Nat224.create();
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.add(this.f19238x, ((SecP224K1FieldElement) eCFieldElement).f19238x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224K1Field.addOne(this.f19238x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.inv(((SecP224K1FieldElement) eCFieldElement).f19238x, create);
        SecP224K1Field.multiply(create, this.f19238x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224K1FieldElement) {
            return Nat224.eq(this.f19238x, ((SecP224K1FieldElement) obj).f19238x);
        }
        return false;
    }
    ...
    public String getFieldName() {
        return StubApp.getString2(32961);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public int getFieldSize() {
        return f19237Q.bitLength();
    }

    public int hashCode() {
        return f19237Q.hashCode() ^ Arrays.hashCode(this.f19238x, 0, 7);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat224.create();
        SecP224K1Field.inv(this.f19238x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f19238x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f19238x);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.multiply(this.f19238x, ((SecP224K1FieldElement) eCFieldElement).f19238x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224K1Field.negate(this.f19238x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f19238x;
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224K1Field.square(this.f19238x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.subtract(this.f19238x, ((SecP224K1FieldElement) eCFieldElement).f19238x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f19238x, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f19238x);
    }

    public SecP224K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f19237Q) >= 0) {
            throw new IllegalArgumentException(StubApp.getString2(32960));
        }
        this.f19238x = SecP224K1Field.fromBigInteger(bigInteger);
    }

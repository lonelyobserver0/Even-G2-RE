...
public class SecT233R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT233R1Curve() {
        ...
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27267))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27268)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawXCoord()).f19269x, 0, jArr, i11);
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawYCoord()).f19269x, 0, jArr, i11 + 4);
            i11 += 8;
        }

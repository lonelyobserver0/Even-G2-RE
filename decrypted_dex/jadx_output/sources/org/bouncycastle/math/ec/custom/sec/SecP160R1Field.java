...
public class SecP160R1Field {
    ...
    private static final long f19213M = 4294967295L;

    /* renamed from: P4, reason: collision with root package name */
    private static final int f19215P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv = -2147483647;

    /* renamed from: P, reason: collision with root package name */
    static final int[] f19214P = {IntCompanionObject.MAX_VALUE, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f19214P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f19214P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f19214P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f19214P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f19214P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j13 = (iArr[0] & 4294967295L) + j + (j << 31);
        iArr2[0] = (int) j13;
        long j14 = (iArr[1] & 4294967295L) + j3 + (j3 << 31) + (j13 >>> 32);
        iArr2[1] = (int) j14;
        long j15 = (iArr[2] & 4294967295L) + j10 + (j10 << 31) + (j14 >>> 32);
        iArr2[2] = (int) j15;
        long j16 = (iArr[3] & 4294967295L) + j11 + (j11 << 31) + (j15 >>> 32);
        iArr2[3] = (int) j16;
        long j17 = (4294967295L & iArr[4]) + j12 + (j12 << 31) + (j16 >>> 32);
        iArr2[4] = (int) j17;
        reduce32((int) (j17 >>> 32), iArr2);
    }

    public static void reduce32(int i3, int[] iArr) {
        if ((i3 == 0 || Nat160.mulWordsAdd(PInv, i3, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f19214P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f19214P))) {
            Nat.addWordTo(5, PInv, iArr2);
        }
    }
}

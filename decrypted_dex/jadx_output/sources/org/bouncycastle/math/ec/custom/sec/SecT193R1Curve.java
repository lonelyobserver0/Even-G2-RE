...
public class SecT193R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R1Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27255))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27256))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27257)));

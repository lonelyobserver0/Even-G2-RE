...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f19245q = SecP256K1FieldElement.f19248Q;
    ...
    public SecP256K1Curve() {
        ...
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27191)));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i3, final int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            ...
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawXCoord()).f19249x, 0, iArr, i11);
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawYCoord()).f19249x, 0, iArr, i11 + 8);
            i11 += 16;
        }

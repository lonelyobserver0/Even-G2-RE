...
public class SecT131R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (v2.isZero()) {
            return new SecT131R1Point(curve, v2, curve.getB().sqrt());
        }
        ...
        return new SecT131R1Point(curve, square2, eCFieldElement.squarePlusProduct(v2, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }

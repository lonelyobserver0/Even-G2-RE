...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R1Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27228))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27229))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27230)));

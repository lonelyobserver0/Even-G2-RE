...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElement8 = this.f19192y;
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElement4 = a.v(divide, divide, xCoord).add(curve.getA());
    ...
    public ECPoint twice() {
        ...
        ECFieldElement v2 = a.v(eCFieldElement2, multiply, a3);
        if (v2.isZero()) {
            return new SecT131R2Point(curve, v2, curve.getB().sqrt());
        }
        ECFieldElement square2 = v2.square();
        ECFieldElement multiply2 = isOne ? v2 : v2.multiply(square);
        if (!isOne) {
            eCFieldElement = eCFieldElement.multiply(eCFieldElement3);
        }
        return new SecT131R2Point(curve, square2, eCFieldElement.squarePlusProduct(v2, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }

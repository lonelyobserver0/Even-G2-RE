...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R1Curve() {
        ...
        this.f19179a = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27246))));
        this.f19180b = fromBigInteger(new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27247))));
        this.order = new BigInteger(1, Hex.decodeStrict(StubApp.getString2(27248)));

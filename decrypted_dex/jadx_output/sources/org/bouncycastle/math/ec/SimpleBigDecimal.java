...
class SimpleBigDecimal {
    ...
    public SimpleBigDecimal(BigInteger bigInteger, int i3) {
        if (i3 < 0) {
            throw new IllegalArgumentException(StubApp.getString2(32929));
        }
    ...
    private void checkScale(SimpleBigDecimal simpleBigDecimal) {
        if (this.scale != simpleBigDecimal.scale) {
            throw new IllegalArgumentException(StubApp.getString2(32930));
        }
    }

    public static SimpleBigDecimal getInstance(BigInteger bigInteger, int i3) {
    ...
    public SimpleBigDecimal adjustScale(int i3) {
        if (i3 < 0) {
            throw new IllegalArgumentException(StubApp.getString2(32929));
        }
        int i10 = this.scale;
        return i3 == i10 ? this : new SimpleBigDecimal(this.bigInt.shiftLeft(i3 - i10), i3);
    }
    ...
    public SimpleBigDecimal shiftLeft(int i3) {
        return new SimpleBigDecimal(this.bigInt.shiftLeft(i3), this.scale);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(StubApp.getString2(1));

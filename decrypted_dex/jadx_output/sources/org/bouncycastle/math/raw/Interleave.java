...
public class Interleave {
    ...
    public static int expand16to32(int i3) {
    ...
    public static long expand32to64(int i3) {
        return (((r6 >>> 1) & M32) << 32) | (M32 & Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i3, 65280, 8), 15728880, 4), 202116108, 2), 572662306, 1));
    }

    public static void expand64To128(long j, long[] jArr, int i3) {
        ...
        jArr[i3] = bitPermuteStep & M64;
        jArr[i3 + 1] = (bitPermuteStep >>> 1) & M64;
    }

    public static void expand64To128Rev(long j, long[] jArr, int i3) {
        long bitPermuteStep = Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(j, 4294901760L, 16), 280375465148160L, 8), 67555025218437360L, 4), 868082074056920076L, 2), 2459565876494606882L, 1);
        jArr[i3] = bitPermuteStep & M64R;
        jArr[i3 + 1] = (bitPermuteStep << 1) & M64R;
    }

    public static int expand8to16(int i3) {
        int i10 = i3 & 255;
    ...
    public static int shuffle(int i3) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i3, 65280, 8), 15728880, 4), 202116108, 2), 572662306, 1);
    }

    public static int shuffle2(int i3) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i3, 11141290, 7), 52428, 14), 15728880, 4), 65280, 8);
    }
    ...
    public static int unshuffle(int i3) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i3, 572662306, 1), 202116108, 2), 15728880, 4), 65280, 8);
    }

    public static int unshuffle2(int i3) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i3, 65280, 8), 15728880, 4), 52428, 14), 11141290, 7);
    }
    ...
    public static void expand64To128(long[] jArr, int i3, int i10, long[] jArr2, int i11) {
        for (int i12 = 0; i12 < i10; i12++) {
            expand64To128(jArr[i3 + i12], jArr2, i11);
            i11 += 2;
        }
    }

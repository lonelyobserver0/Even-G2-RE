...
public abstract class Nat448 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        boolean z2 = Nat224.diff(iArr, 7, iArr, 0, create, 0) != Nat224.diff(iArr2, 7, iArr2, 0, create2, 0);
        int[] createExt = Nat224.createExt();
        Nat224.mul(create, create2, createExt);
        Nat.addWordAt(28, addTo + (z2 ? Nat.addTo(14, createExt, 0, iArr3, 7) : Nat.subFrom(14, createExt, 0, iArr3, 7)), iArr3, 21);
    }
    ...
    public static BigInteger toBigInteger64(long[] jArr) {
        ...
        for (int i3 = 0; i3 < 7; i3++) {
            long j = jArr[i3];
            if (j != 0) {
                Pack.longToBigEndian(j, bArr, (6 - i3) << 3);
            }
        }

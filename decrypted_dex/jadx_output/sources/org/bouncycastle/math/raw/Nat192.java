...
public abstract class Nat192 {
    ...
    private static final long f19310M = 4294967295L;
    ...
    public static int addTo(int[] iArr, int i3, int[] iArr2, int i10, int i11) {
        ...
        iArr2[i10 + 4] = (int) j12;
        long j13 = (iArr[i3 + 5] & 4294967295L) + (4294967295L & iArr2[r12]) + (j12 >>> 32);
        iArr2[i10 + 5] = (int) j13;
        return (int) (j13 >>> 32);
    }
    ...
    public static void mul(int[] iArr, int i3, int[] iArr2, int i10, int[] iArr3, int i11) {
        ...
        while (i12 < 6) {
            int i14 = i13 + 1;
            long j21 = iArr[i3 + i12] & 4294967295L;
            int i15 = i13;
            long j22 = (j21 * j) + (iArr3[i14] & 4294967295L);
            iArr3[i14] = (int) j22;
            long j23 = (j21 * j3) + (iArr3[r3] & 4294967295L) + (j22 >>> 32);
            iArr3[i15 + 2] = (int) j23;
            long j24 = (j21 * j10) + (iArr3[r21] & 4294967295L) + (j23 >>> 32);
            iArr3[i15 + 3] = (int) j24;
            long j25 = (j21 * j11) + (iArr3[r21] & 4294967295L) + (j24 >>> 32);
            iArr3[i15 + 4] = (int) j25;
            long j26 = (j21 * j12) + (iArr3[r21] & 4294967295L) + (j25 >>> 32);
            iArr3[i15 + 5] = (int) j26;
            long j27 = j26 >>> 32;
            long j28 = (j21 * j13) + (iArr3[r2] & 4294967295L) + j27;
            iArr3[i15 + 6] = (int) j28;
    ...
    public static long mul33Add(int i3, int[] iArr, int i10, int[] iArr2, int i11, int[] iArr3, int i12) {
        ...
        long j20 = (j * j19) + j17 + (4294967295L & iArr2[i11 + 5]) + (j18 >>> 32);
        iArr3[i12 + 5] = (int) j20;
        return (j20 >>> 32) + j19;
    }
    ...
    public static int mulAddTo(int[] iArr, int i3, int[] iArr2, int i10, int[] iArr3, int i11) {
        ...
        int i13 = i11;
        while (i12 < 6) {
            long j15 = iArr[i3 + i12] & 4294967295L;
            long j16 = (j15 * j) + (iArr3[i13] & 4294967295L);
            long j17 = j3;
            iArr3[i13] = (int) j16;
            int i14 = i13 + 1;
            long j18 = (j15 * j17) + (iArr3[i14] & 4294967295L) + (j16 >>> 32);
            iArr3[i14] = (int) j18;
            long j19 = (j15 * j10) + (iArr3[r4] & 4294967295L) + (j18 >>> 32);
            iArr3[i13 + 2] = (int) j19;
            long j20 = (j15 * j11) + (iArr3[r4] & 4294967295L) + (j19 >>> 32);
            iArr3[i13 + 3] = (int) j20;
            long j21 = (j15 * j12) + (iArr3[r4] & 4294967295L) + (j20 >>> 32);
            iArr3[i13 + 4] = (int) j21;
            long j22 = (j15 * j13) + (iArr3[r4] & 4294967295L) + (j21 >>> 32);
            iArr3[i13 + 5] = (int) j22;
    ...
    public static int mulWordAddExt(int i3, int[] iArr, int i10, int[] iArr2, int i11) {
        ...
        iArr2[i11 + 4] = (int) j13;
        long j14 = (j * (iArr[i10 + 5] & 4294967295L)) + (iArr2[r15] & 4294967295L) + (j13 >>> 32);
        iArr2[i11 + 5] = (int) j14;
        return (int) (j14 >>> 32);
    }
    ...
    public static void square(int[] iArr, int i3, int[] iArr2, int i10) {
        ...
        while (true) {
            ...
            if (i14 <= 0) {
                ...
                long j25 = j22 + (i21 >>> 32);
                long j26 = iArr[i3 + 4] & 4294967295L;
                long j27 = (iArr2[r4] & 4294967295L) + (j25 >>> 32);
                long j28 = j25 & 4294967295L;
                long j29 = (j26 * j) + (i20 & 4294967295L);
                int i22 = (int) j29;
                iArr2[i10 + 4] = (i19 >>> 31) | (i22 << 1);
                int i23 = i22 >>> 31;
                long i24 = u.i(j26, j13, j29 >>> 32, i21 & 4294967295L);
                long i25 = u.i(j26, j16, i24 >>> 32, j28);
                long i26 = u.i(j26, j19, i25 >>> 32, j27 & 4294967295L);
                long j30 = i25 & 4294967295L;
                long j31 = (iArr2[r5] & 4294967295L) + (j27 >>> 32) + (i26 >>> 32);
                long j32 = iArr[i3 + 5] & 4294967295L;
                long j33 = (iArr2[r8] & 4294967295L) + (j31 >>> 32);
                long j34 = j31 & 4294967295L;
                long j35 = (iArr2[r0] & 4294967295L) + (j33 >>> 32);
                long j36 = j33 & 4294967295L;
                long j37 = (j32 * j) + (i24 & 4294967295L);
                int i27 = (int) j37;
                iArr2[i10 + 5] = i23 | (i27 << 1);
                int i28 = i27 >>> 31;
                long i29 = u.i(j32, j13, j37 >>> 32, j30);
                long i30 = u.i(j32, j16, i29 >>> 32, i26 & 4294967295L);
                long i31 = u.i(j32, j19, i30 >>> 32, j34);
                long i32 = u.i(j32, j26, i31 >>> 32, j36);
                long j38 = j35 + (i32 >>> 32);
                int i33 = (int) i29;
                iArr2[i10 + 6] = i28 | (i33 << 1);
                int i34 = (int) i30;
                iArr2[i10 + 7] = (i33 >>> 31) | (i34 << 1);
                int i35 = i34 >>> 31;
                int i36 = (int) i31;
                iArr2[i10 + 8] = i35 | (i36 << 1);
                int i37 = i36 >>> 31;
                int i38 = (int) i32;
                iArr2[i10 + 9] = i37 | (i38 << 1);
                int i39 = i38 >>> 31;
                int i40 = (int) j38;
                iArr2[i10 + 10] = i39 | (i40 << 1);
                int i41 = i40 >>> 31;
                int i42 = i10 + 11;
                iArr2[i42] = ((iArr2[i42] + ((int) (j38 >>> 32))) << 1) | i41;
                return;
            }
            i13 = i14;
        }
    ...
    public static int subFrom(int[] iArr, int i3, int[] iArr2, int i10) {
        ...
        iArr2[i10 + 4] = (int) j12;
        long j13 = ((iArr2[r13] & 4294967295L) - (iArr[i3 + 5] & 4294967295L)) + (j12 >> 32);
        iArr2[i10 + 5] = (int) j13;
        return (int) (j13 >> 32);
    }
    ...
    public static BigInteger toBigInteger(int[] iArr) {
        ...
        for (int i3 = 0; i3 < 6; i3++) {
            int i10 = iArr[i3];
            if (i10 != 0) {
                Pack.intToBigEndian(i10, bArr, (5 - i3) << 2);
            }
        }
    ...
    public static BigInteger toBigInteger64(long[] jArr) {
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            long j = jArr[i3];
            if (j != 0) {
                Pack.longToBigEndian(j, bArr, (2 - i3) << 3);
            }
        }
        return new BigInteger(1, bArr);
    }
    ...
    public static int addTo(int[] iArr, int[] iArr2) {
        ...
        long j12 = (iArr[4] & 4294967295L) + (iArr2[4] & 4294967295L) + (j11 >>> 32);
        iArr2[4] = (int) j12;
        long j13 = (iArr[5] & 4294967295L) + (4294967295L & iArr2[5]) + (j12 >>> 32);
        iArr2[5] = (int) j13;
        return (int) (j13 >>> 32);
    }
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (true) {
            ...
            long j22 = (j21 * j) + (iArr3[i11] & 4294967295L);
            iArr3[i11] = (int) j22;
            i3 = i11 + 1;
            long j23 = j12;
            long j24 = (j21 * j3) + (iArr3[i3] & 4294967295L) + (j22 >>> 32);
            iArr3[i3] = (int) j24;
            long j25 = (j21 * j10) + (iArr3[r5] & 4294967295L) + (j24 >>> 32);
            iArr3[i11 + 2] = (int) j25;
            long j26 = (j21 * j11) + (iArr3[r5] & 4294967295L) + (j25 >>> 32);
            iArr3[i11 + 3] = (int) j26;
            long j27 = (j21 * j23) + (iArr3[r5] & 4294967295L) + (j26 >>> 32);
            iArr3[i11 + 4] = (int) j27;
            long j28 = (j21 * j13) + (iArr3[r5] & 4294967295L) + (j27 >>> 32);
            iArr3[i11 + 5] = (int) j28;
            iArr3[i11 + 6] = (int) (j28 >>> 32);
            j12 = j23;
            i10 = 6;
        }
    }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i3 < 6) {
            ...
            long j17 = (iArr3[i10] & 4294967295L) + (j16 * j15);
            iArr3[i10] = (int) j17;
            int i11 = i10 + 1;
            long j18 = (j16 * j3) + (iArr3[i11] & 4294967295L) + (j17 >>> 32);
            iArr3[i11] = (int) j18;
            long j19 = (j16 * j10) + (iArr3[r15] & 4294967295L) + (j18 >>> 32);
            iArr3[i10 + 2] = (int) j19;
            long j20 = (j16 * j11) + (iArr3[r2] & 4294967295L) + (j19 >>> 32);
            iArr3[i10 + 3] = (int) j20;
            long j21 = (j16 * j12) + (iArr3[r2] & 4294967295L) + (j20 >>> 32);
            iArr3[i10 + 4] = (int) j21;
            long j22 = (j16 * j13) + (iArr3[r2] & 4294967295L) + (j21 >>> 32);
            iArr3[i10 + 5] = (int) j22;
            long j23 = (j22 >>> 32) + (iArr3[r2] & 4294967295L) + j14;
            iArr3[i10 + 6] = (int) j23;
            j14 = j23 >>> 32;
            i3 = i11;
            j = j15;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i12 <= 0) {
                ...
                int i39 = (int) j38;
                iArr2[10] = i38 | (i39 << 1);
                iArr2[11] = ((iArr2[11] + ((int) (j38 >>> 32))) << 1) | (i39 >>> 31);
                return;
            }
            i11 = i12;
        }
    ...
    public static int subFrom(int[] iArr, int[] iArr2) {
        ...
        iArr2[4] = (int) j12;
        long j13 = ((iArr2[5] & 4294967295L) - (4294967295L & iArr[5])) + (j12 >> 32);
        iArr2[5] = (int) j13;
        return (int) (j13 >> 32);
    }
}

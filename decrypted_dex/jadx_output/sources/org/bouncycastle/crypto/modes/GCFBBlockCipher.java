...
public class GCFBBlockCipher extends StreamBlockCipher {
    ...
    private static final byte[] f19030C = {105, 0, 114, 34, 100, -55, 4, 35, -115, 58, -37, -106, 70, -23, 42, -60, 24, -2, -84, -108, 0, -19, 7, 18, -64, -122, -36, -62, -17, 76, -87, 43};
    ...
    public String getAlgorithmName() {
        ...
        return algorithmName.substring(0, algorithmName.indexOf(47)) + StubApp.getString2(29107) + algorithmName.substring(algorithmName.indexOf(47) + 1);
    }
    ...
    public int processBlock(byte[] bArr, int i3, byte[] bArr2, int i10) throws DataLengthException, IllegalStateException {
        processBytes(bArr, i3, this.cfbEngine.getBlockSize(), bArr2, i10);
        return this.cfbEngine.getBlockSize();
    }

...
public class DHKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(StubApp.getString2(28899), ConstraintUtils.bitsOfSecurityFor(dHKeyGenerationParameters.getParameters().getP()), this.param.getParameters(), CryptoServicePurpose.KEYGEN));
    }
}

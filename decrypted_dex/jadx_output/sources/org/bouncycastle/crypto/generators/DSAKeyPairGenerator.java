...
public class DSAKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(StubApp.getString2(28900), ConstraintUtils.bitsOfSecurityFor(dSAKeyGenerationParameters.getParameters().getP()), this.param.getParameters(), CryptoServicePurpose.KEYGEN));
    }
}

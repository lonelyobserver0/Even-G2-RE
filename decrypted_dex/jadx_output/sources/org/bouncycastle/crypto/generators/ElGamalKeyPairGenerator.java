...
public class ElGamalKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(StubApp.getString2(28911), ConstraintUtils.bitsOfSecurityFor(elGamalKeyGenerationParameters.getParameters().getP()), this.param.getParameters(), CryptoServicePurpose.KEYGEN));
    }
}

...
public class Haraka256Digest extends HarakaBase {
    ...
    private int haraka256256(byte[] bArr, byte[] bArr2, int i3) {
        Class cls = Byte.TYPE;
        ...
        System.arraycopy(bArr3[0], 0, bArr2, i3, 16);
        System.arraycopy(bArr3[1], 0, bArr2, i3 + 16, 16);
        return 32;
    }
    ...
    public int doFinal(byte[] bArr, int i3) {
        if (this.off != 32) {
            throw new IllegalStateException(StubApp.getString2(28482));
        }
        if (bArr.length - i3 < 32) {
            throw new IllegalArgumentException(StubApp.getString2(28481));
        }
        int haraka256256 = haraka256256(this.buffer, bArr, i3);
        reset();
        return haraka256256;
    }
    ...
    public String getAlgorithmName() {
        return StubApp.getString2(28483);
    }

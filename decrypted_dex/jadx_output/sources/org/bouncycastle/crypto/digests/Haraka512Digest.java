...
public class Haraka512Digest extends HarakaBase {
    ...
    private int haraka512256(byte[] bArr, byte[] bArr2, int i3) {
        Class cls = Byte.TYPE;
        ...
        System.arraycopy(bArr3[0], 8, bArr2, i3, 8);
        System.arraycopy(bArr3[1], 8, bArr2, i3 + 8, 8);
        System.arraycopy(bArr3[2], 0, bArr2, i3 + 16, 8);
        System.arraycopy(bArr3[3], 0, bArr2, i3 + 24, 8);
        return 32;
    }
    ...
    public int doFinal(byte[] bArr, int i3) {
        if (this.off != 64) {
            throw new IllegalStateException(StubApp.getString2(28485));
        }
        if (bArr.length - i3 < 32) {
            throw new IllegalArgumentException(StubApp.getString2(28481));
        }
        int haraka512256 = haraka512256(this.buffer, bArr, i3);
        reset();
        return haraka512256;
    }
    ...
    public String getAlgorithmName() {
        return StubApp.getString2(28486);
    }

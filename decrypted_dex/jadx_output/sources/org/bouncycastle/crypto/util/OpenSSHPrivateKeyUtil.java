...
public class OpenSSHPrivateKeyUtil {
    static final byte[] AUTH_MAGIC = Strings.toByteArray(StubApp.getString2(29351));
    ...
    public static byte[] encodePrivateKey(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        if (asymmetricKeyParameter == null) {
            throw new IllegalArgumentException(StubApp.getString2(29356));
        }
        if (!(asymmetricKeyParameter instanceof RSAPrivateCrtKeyParameters) && !(asymmetricKeyParameter instanceof ECPrivateKeyParameters)) {
            if (asymmetricKeyParameter instanceof DSAPrivateKeyParameters) {
                ...
                try {
                    ...
                    throw new IllegalStateException(u.r(e10, new StringBuilder(StubApp.getString2(29352))));
                }
            }
            if (!(asymmetricKeyParameter instanceof Ed25519PrivateKeyParameters)) {
                throw new IllegalArgumentException(StubApp.getString2(29354) + asymmetricKeyParameter.getClass().getName() + StubApp.getString2(29355));
            }
            ...
            sSHBuilder2.u32(nextInt);
            sSHBuilder2.writeString(StubApp.getString2(29353));
    ...
    public static AsymmetricKeyParameter parsePrivateKeyBlob(byte[] bArr) {
        ...
        if (bArr[0] == 48) {
            ...
            if (!StubApp.getString2(1337).equals(sSHBuffer.readString())) {
                throw new IllegalStateException(StubApp.getString2(29367));
            }
            sSHBuffer.skipBlock();
            sSHBuffer.skipBlock();
            if (sSHBuffer.readU32() != 1) {
                throw new IllegalStateException(StubApp.getString2(29366));
            }
            ...
            if (sSHBuffer2.readU32() != sSHBuffer2.readU32()) {
                throw new IllegalStateException(StubApp.getString2(29364));
            }
            String readString = sSHBuffer2.readString();
            if (StubApp.getString2(29353).equals(readString)) {
                sSHBuffer2.readBlock();
                byte[] readBlock = sSHBuffer2.readBlock();
                if (readBlock.length != 64) {
                    throw new IllegalStateException(StubApp.getString2(29357));
                }
                ...
                if (byName == null) {
                    throw new IllegalStateException(StubApp.getString2(29360).concat(readString));
                }
                X9ECParameters byOID = NISTNamedCurves.getByOID(byName);
                if (byOID == null) {
                    throw new IllegalStateException(a.e(StubApp.getString2(29359), byName));
                }
                sSHBuffer2.readBlock();
            ...
            } else if (readString.startsWith(StubApp.getString2(29361))) {
            ...
            if (sSHBuffer2.hasRemaining()) {
                throw new IllegalArgumentException(StubApp.getString2(29363));
            }
        }
        if (asymmetricKeyParameter != null) {

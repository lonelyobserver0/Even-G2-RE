...
public class AlgorithmIdentifierFactory {
    static final ASN1ObjectIdentifier IDEA_CBC = a.u(StubApp.getString2(27377));
    static final ASN1ObjectIdentifier CAST5_CBC = a.u(StubApp.getString2(27378));
    ...
    public static AlgorithmIdentifier generateEncryptionAlgID(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i3, SecureRandom secureRandom) throws IllegalArgumentException {
        ...
        if (aSN1ObjectIdentifier.equals((ASN1Primitive) CAST5_CBC)) {
            ...
            return new AlgorithmIdentifier(aSN1ObjectIdentifier, new CAST5CBCParameters(bArr5, i3));
        }
        ...
        if (!aSN1ObjectIdentifier.equals((ASN1Primitive) PKCSObjectIdentifiers.RC2_CBC)) {
            throw new IllegalArgumentException(StubApp.getString2(29334));
        }

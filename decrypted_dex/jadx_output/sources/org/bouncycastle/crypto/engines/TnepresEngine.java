...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i3, byte[] bArr2, int i10) {
        int[] iArr = {r3, this.wKey[129] ^ Pack.bigEndianToInt(bArr, i3 + 8), this.wKey[130] ^ Pack.bigEndianToInt(bArr, i3 + 4), this.wKey[131] ^ Pack.bigEndianToInt(bArr, i3)};
        int bigEndianToInt = this.wKey[128] ^ Pack.bigEndianToInt(bArr, i3 + 12);
        ib7(iArr, bigEndianToInt, iArr[1], iArr[2], iArr[3]);
        int i11 = iArr[0];
        int[] iArr2 = this.wKey;
        iArr[0] = i11 ^ iArr2[124];
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToBigEndian(iArr[3] ^ this.wKey[3], bArr2, i10);
        Pack.intToBigEndian(iArr[2] ^ this.wKey[2], bArr2, i10 + 4);
        Pack.intToBigEndian(iArr[1] ^ this.wKey[1], bArr2, i10 + 8);
        Pack.intToBigEndian(this.wKey[0] ^ iArr[0], bArr2, i10 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i3, byte[] bArr2, int i10) {
        int[] iArr = {r12, Pack.bigEndianToInt(bArr, i3 + 8), Pack.bigEndianToInt(bArr, i3 + 4), Pack.bigEndianToInt(bArr, i3)};
        int bigEndianToInt = Pack.bigEndianToInt(bArr, i3 + 12);
        int[] iArr2 = this.wKey;
        sb0(iArr, iArr2[0] ^ bigEndianToInt, iArr[1] ^ iArr2[1], iArr[2] ^ iArr2[2], iArr2[3] ^ iArr[3]);
        LT(iArr);
        int[] iArr3 = this.wKey;
        ...
        Pack.intToBigEndian(this.wKey[131] ^ iArr[3], bArr2, i10);
        Pack.intToBigEndian(this.wKey[130] ^ iArr[2], bArr2, i10 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ iArr[1], bArr2, i10 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ iArr[0], bArr2, i10 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase, org.bouncycastle.crypto.BlockCipher
    public String getAlgorithmName() {
        return StubApp.getString2(28787);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        int i3 = 0;
        while (length > 0) {
            iArr[i3] = Pack.bigEndianToInt(bArr, length);
            length -= 4;
            i3++;
        }
        if (length != 0) {
            throw new IllegalArgumentException(StubApp.getString2(28767));
        }
        int i10 = i3 + 1;
        ...
        for (int i11 = 8; i11 < 16; i11++) {
            int i12 = i11 - 8;
            iArr[i11] = SerpentEngineBase.rotateLeft(((-1640531527) ^ (((iArr[i12] ^ iArr[i11 - 5]) ^ iArr[i11 - 3]) ^ iArr[i11 - 1])) ^ i12, 11);
        }
        System.arraycopy(iArr, 8, iArr2, 0, 8);
        for (int i13 = 8; i13 < 132; i13++) {
            iArr2[i13] = SerpentEngineBase.rotateLeft(((((iArr2[i13 - 8] ^ iArr2[i13 - 5]) ^ iArr2[i13 - 3]) ^ iArr2[i13 - 1]) ^ (-1640531527)) ^ i13, 11);
        }
        int[] iArr3 = new int[4];

...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    ...
    private static int MAKEU31(byte b2, byte b10, byte b11, byte b12) {
        return ((b2 & UByte.MAX_VALUE) << 23) | ((b10 & UByte.MAX_VALUE) << 16) | ((b11 & UByte.MAX_VALUE) << 8) | (b12 & UByte.MAX_VALUE);
    }
    ...
    public String getAlgorithmName() {
        return StubApp.getString2(28805);
    }
    ...
    public void setKeyAndIV(int[] iArr, byte[] bArr, byte[] bArr2) {
        if (bArr == null || bArr.length != 32) {
            throw new IllegalArgumentException(StubApp.getString2(28807));
        }
        if (bArr2 == null || bArr2.length != 25) {
            throw new IllegalArgumentException(StubApp.getString2(28806));
        }
    ...
    public Zuc256CoreEngine(int i3) {
        if (i3 == 32) {
            this.theD = EK_d32;
        } else if (i3 == 64) {
            this.theD = EK_d64;
            ...
            if (i3 != 128) {
                throw new IllegalArgumentException(u.p(i3, StubApp.getString2(28804)));
            }
            this.theD = EK_d128;
        }
    }

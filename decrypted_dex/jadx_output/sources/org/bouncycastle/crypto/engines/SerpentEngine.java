...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i3, byte[] bArr2, int i10) {
        int littleEndianToInt = this.wKey[131] ^ Pack.littleEndianToInt(bArr, i3 + 12);
        int[] iArr = {this.wKey[128] ^ Pack.littleEndianToInt(bArr, i3), this.wKey[129] ^ Pack.littleEndianToInt(bArr, i3 + 4), this.wKey[130] ^ Pack.littleEndianToInt(bArr, i3 + 8), littleEndianToInt};
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToLittleEndian(iArr[0] ^ this.wKey[0], bArr2, i10);
        Pack.intToLittleEndian(iArr[1] ^ this.wKey[1], bArr2, i10 + 4);
        Pack.intToLittleEndian(iArr[2] ^ this.wKey[2], bArr2, i10 + 8);
        Pack.intToLittleEndian(this.wKey[3] ^ iArr[3], bArr2, i10 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i3, byte[] bArr2, int i10) {
        int[] iArr = {Pack.littleEndianToInt(bArr, i3), Pack.littleEndianToInt(bArr, i3 + 4), Pack.littleEndianToInt(bArr, i3 + 8), Pack.littleEndianToInt(bArr, i3 + 12)};
        int[] iArr2 = this.wKey;
        ...
        Pack.intToLittleEndian(this.wKey[128] ^ iArr[0], bArr2, i10);
        Pack.intToLittleEndian(this.wKey[129] ^ iArr[1], bArr2, i10 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ iArr[2], bArr2, i10 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ iArr[3], bArr2, i10 + 12);
    }

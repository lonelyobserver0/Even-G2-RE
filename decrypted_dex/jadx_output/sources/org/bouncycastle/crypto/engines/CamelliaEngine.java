...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i3) {
        ...
        int i11 = iArr3[i10 & 255];
        int[] iArr4 = SBOX3_3033;
        int i12 = i11 ^ iArr4[(i10 >>> 8) & 255];
        int[] iArr5 = SBOX2_0222;
        int i13 = i12 ^ iArr5[(i10 >>> 16) & 255];
        int[] iArr6 = SBOX1_1110;
        int i14 = iArr6[(i10 >>> 24) & 255] ^ i13;
        int i15 = iArr[1] ^ iArr2[i3 + 1];
        int i16 = (iArr5[(i15 >>> 24) & 255] ^ ((iArr6[i15 & 255] ^ iArr3[(i15 >>> 8) & 255]) ^ iArr4[(i15 >>> 16) & 255])) ^ i14;
        iArr[2] = iArr[2] ^ i16;
        int rightRotate = (rightRotate(i14, 8) ^ i16) ^ iArr[3];
        iArr[3] = rightRotate;
        int i17 = iArr[2] ^ iArr2[i3 + 2];
        int i18 = iArr6[(i17 >>> 24) & 255] ^ ((iArr3[i17 & 255] ^ iArr4[(i17 >>> 8) & 255]) ^ iArr5[(i17 >>> 16) & 255]);
        int i19 = iArr2[i3 + 3] ^ rightRotate;
        int i20 = (iArr5[(i19 >>> 24) & 255] ^ ((iArr6[i19 & 255] ^ iArr3[(i19 >>> 8) & 255]) ^ iArr4[(i19 >>> 16) & 255])) ^ i18;
        iArr[0] = iArr[0] ^ i20;
        iArr[1] = (i20 ^ rightRotate(i18, 8)) ^ iArr[1];
    }
    ...
    public int processBlock(byte[] bArr, int i3, byte[] bArr2, int i10) throws DataLengthException, IllegalStateException {
        if (!this.initialised) {
            throw new IllegalStateException(StubApp.getString2(28571));
        }

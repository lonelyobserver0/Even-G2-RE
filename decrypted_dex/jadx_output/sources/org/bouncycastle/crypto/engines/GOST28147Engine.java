...
public class GOST28147Engine implements BlockCipher {
    ...
    private byte[] f18943S = Sbox_Default;

    static {
        addSBox(StubApp.getString2(9991), Sbox_Default);
        addSBox(StubApp.getString2(28626), ESbox_Test);
        addSBox(StubApp.getString2(28627), ESbox_A);
        addSBox(StubApp.getString2(28628), ESbox_B);
        addSBox(StubApp.getString2(28629), ESbox_C);
        addSBox(StubApp.getString2(28630), ESbox_D);
        addSBox(StubApp.getString2(28631), Param_Z);
        addSBox(StubApp.getString2(28632), DSbox_Test);
        addSBox(StubApp.getString2(28480), DSbox_A);
    }
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i3, byte[] bArr2, int i10) {
        int i11;
        int i12;
        ...
        if (this.forEncryption) {
            for (int i14 = 0; i14 < 3; i14++) {
                int i15 = 0;
                while (i15 < 8) {
                    int GOST28147_mainStep = bytesToint2 ^ GOST28147_mainStep(bytesToint, iArr[i15]);
                    i15++;
                    int i16 = bytesToint;
            ...
            i12 = bytesToint;
            while (i13 > 0) {
                int GOST28147_mainStep2 = i11 ^ GOST28147_mainStep(i12, iArr[i13]);
                i13--;
                i11 = i12;
            ...
            int i17 = 0;
            while (i17 < 8) {
                int GOST28147_mainStep3 = bytesToint2 ^ GOST28147_mainStep(bytesToint, iArr[i17]);
                i17++;
                int i18 = bytesToint;
            ...
            for (int i19 = 0; i19 < 3; i19++) {
                ...
                while (i20 >= 0 && (i19 != 2 || i20 != 0)) {
                    int GOST28147_mainStep4 = i11 ^ GOST28147_mainStep(i12, iArr[i20]);
                    i20--;
                    i11 = i12;
                    i12 = GOST28147_mainStep4;
                }
            }
        }
        int GOST28147_mainStep5 = GOST28147_mainStep(i12, iArr[0]) ^ i11;
        intTobytes(i12, bArr2, i10);
        intTobytes(GOST28147_mainStep5, bArr2, i10 + 4);
    }

    private int GOST28147_mainStep(int i3, int i10) {
        int i11 = i10 + i3;
        byte[] bArr = this.f18943S;
    ...
    public static byte[] getSBox(String str) {
        ...
        throw new IllegalArgumentException(StubApp.getString2(28634));
    }
    ...
    public static String getSBoxName(byte[] bArr) {
        ...
        throw new IllegalArgumentException(StubApp.getString2(28635));
    }
    ...
    public String getAlgorithmName() {
        return StubApp.getString2(28261);
    }
    ...
    public void init(boolean z2, CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithSBox) {
            ...
            if (sBox.length != Sbox_Default.length) {
                throw new IllegalArgumentException(StubApp.getString2(28636));
            }
            this.f18943S = Arrays.clone(sBox);
        ...
        CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(getAlgorithmName(), 178, cipherParameters, Utils.getPurpose(z2)));
    }
    ...
    public int processBlock(byte[] bArr, int i3, byte[] bArr2, int i10) {
        ...
        if (iArr == null) {
            throw new IllegalStateException(StubApp.getString2(28638));
        }
        if (i3 + 8 > bArr.length) {
        ...
        GOST28147Func(iArr, bArr, i3, bArr2, i10);
        return 8;
    }

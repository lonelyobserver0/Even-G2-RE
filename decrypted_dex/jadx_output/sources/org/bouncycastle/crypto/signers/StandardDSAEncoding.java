...
public class StandardDSAEncoding implements DSAEncoding {
    ...
    public BigInteger[] decode(BigInteger bigInteger, byte[] bArr) throws IOException {
        ...
        throw new IllegalArgumentException(StubApp.getString2(29333));
    }

    public BigInteger decodeValue(BigInteger bigInteger, ASN1Sequence aSN1Sequence, int i3) {
        return checkValue(bigInteger, ((ASN1Integer) aSN1Sequence.getObjectAt(i3)).getValue());
    }

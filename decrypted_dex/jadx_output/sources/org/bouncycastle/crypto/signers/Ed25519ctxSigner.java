...
public class Ed25519ctxSigner implements Signer {
    ...
    /* renamed from: org.bouncycastle.crypto.signers.Ed25519ctxSigner$1, reason: invalid class name */
    ...
    public byte[] generateSignature() {
        ...
        if (!this.forSigning || (ed25519PrivateKeyParameters = this.privateKey) == null) {
            throw new IllegalStateException(StubApp.getString2(29302));
        }
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (this.forSigning || (ed25519PublicKeyParameters = this.publicKey) == null) {
            throw new IllegalStateException(StubApp.getString2(29303));
        }

...
public class BCXMSSMTPrivateKey implements PrivateKey, XMSSMTPrivateKey {
    ...
    public XMSSMTPrivateKey extractKeyShard(int i3) {
        return new BCXMSSMTPrivateKey(this.treeDigest, this.keyParams.extractKeyShard(i3));
    }

    @Override // java.security.Key
    public String getAlgorithm() {
        return StubApp.getString2(32735);
    }

...
public class SignatureSpi extends java.security.SignatureSpi {
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (!(privateKey instanceof BCSphincs256PrivateKey)) {
            throw new InvalidKeyException(StubApp.getString2(34710));
        }
        ...
        if (!this.treeDigest.equals((ASN1Primitive) bCSphincs256PrivateKey.getTreeDigest())) {
            throw new InvalidKeyException(StubApp.getString2(34709) + bCSphincs256PrivateKey.getTreeDigest());
        }
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        if (!(publicKey instanceof BCSphincs256PublicKey)) {
            throw new InvalidKeyException(StubApp.getString2(34711));
        }
        ...
        if (!this.treeDigest.equals((ASN1Primitive) bCSphincs256PublicKey.getTreeDigest())) {
            throw new InvalidKeyException(StubApp.getString2(34709) + bCSphincs256PublicKey.getTreeDigest());
        }

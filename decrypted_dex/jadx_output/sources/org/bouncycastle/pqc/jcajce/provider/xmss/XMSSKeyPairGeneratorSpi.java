...
public class XMSSKeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public XMSSKeyPairGeneratorSpi() {
        super(StubApp.getString2(32734));
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        if (!(algorithmParameterSpec instanceof XMSSParameterSpec)) {
            throw new InvalidAlgorithmParameterException(StubApp.getString2(34726));
        }
        XMSSParameterSpec xMSSParameterSpec = (XMSSParameterSpec) algorithmParameterSpec;
        if (xMSSParameterSpec.getTreeDigest().equals(StubApp.getString2(21749))) {
        ...
        } else if (xMSSParameterSpec.getTreeDigest().equals(StubApp.getString2(21751))) {
            ...
            if (!xMSSParameterSpec.getTreeDigest().equals(StubApp.getString2(28183))) {
                if (xMSSParameterSpec.getTreeDigest().equals(StubApp.getString2(28184))) {

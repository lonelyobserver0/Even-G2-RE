...
public abstract class CipherSpiExt extends CipherSpi {
    ...
    public abstract int doFinal(byte[] bArr, int i3, int i10, byte[] bArr2, int i11) throws ShortBufferException, IllegalBlockSizeException, BadPaddingException;

    public final byte[] doFinal() throws IllegalBlockSizeException, BadPaddingException {
        return doFinal(null, 0, 0);
    }

    public abstract byte[] doFinal(byte[] bArr, int i3, int i10) throws IllegalBlockSizeException, BadPaddingException;

    @Override // javax.crypto.CipherSpi
    public final int engineDoFinal(byte[] bArr, int i3, int i10, byte[] bArr2, int i11) throws ShortBufferException, IllegalBlockSizeException, BadPaddingException {
        return doFinal(bArr, i3, i10, bArr2, i11);
    }
    ...
    public final int engineGetKeySize(Key key) throws InvalidKeyException {
        ...
        throw new InvalidKeyException(StubApp.getString2(34721));
    }

    @Override // javax.crypto.CipherSpi
    public final int engineGetOutputSize(int i3) {
        return getOutputSize(i3);
    }
    ...
    public final void engineInit(int i3, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (algorithmParameters == null) {
            engineInit(i3, key, secureRandom);
        } else {
    ...
    @Override // javax.crypto.CipherSpi
    public final int engineUpdate(byte[] bArr, int i3, int i10, byte[] bArr2, int i11) throws ShortBufferException {
        return update(bArr, i3, i10, bArr2, i11);
    }
    ...
    public abstract int getOutputSize(int i3);
    ...
    public abstract int update(byte[] bArr, int i3, int i10, byte[] bArr2, int i11) throws ShortBufferException;

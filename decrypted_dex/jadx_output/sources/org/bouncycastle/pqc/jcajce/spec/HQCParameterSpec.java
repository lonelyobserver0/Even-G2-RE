...
public class HQCParameterSpec implements AlgorithmParameterSpec {
    ...
    static {
        ...
        parameters = hashMap;
        hashMap.put(StubApp.getString2(34739), hQCParameterSpec);
        parameters.put(StubApp.getString2(34740), hQCParameterSpec2);
        parameters.put(StubApp.getString2(34741), hQCParameterSpec3);
    }

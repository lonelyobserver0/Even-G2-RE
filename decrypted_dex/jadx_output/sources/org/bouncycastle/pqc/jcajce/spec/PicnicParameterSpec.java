...
public class PicnicParameterSpec implements AlgorithmParameterSpec {
    ...
    static {
        ...
        parameters = hashMap;
        hashMap.put(StubApp.getString2(34113), picnicParameterSpec);
        parameters.put(StubApp.getString2(34114), picnicParameterSpec2);
        parameters.put(StubApp.getString2(34115), picnicParameterSpec3);
        parameters.put(StubApp.getString2(34116), picnicParameterSpec4);
        parameters.put(StubApp.getString2(34117), picnicParameterSpec5);
        parameters.put(StubApp.getString2(34118), picnicParameterSpec6);
        parameters.put(StubApp.getString2(34119), picnicParameterSpec7);
        parameters.put(StubApp.getString2(34120), picnicParameterSpec8);
        parameters.put(StubApp.getString2(34121), picnicParameterSpec9);
        parameters.put(StubApp.getString2(34122), picnicParameterSpec10);
        parameters.put(StubApp.getString2(34123), picnicParameterSpec11);
        parameters.put(StubApp.getString2(34124), picnicParameterSpec12);
    }

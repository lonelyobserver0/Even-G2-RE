...
public class NTRULPRimeParameterSpec implements AlgorithmParameterSpec {
    ...
    static {
        ...
        parameters = hashMap;
        hashMap.put(StubApp.getString2(34054), nTRULPRimeParameterSpec);
        parameters.put(StubApp.getString2(34055), nTRULPRimeParameterSpec2);
        parameters.put(StubApp.getString2(34056), nTRULPRimeParameterSpec3);
        parameters.put(StubApp.getString2(34057), nTRULPRimeParameterSpec4);
        parameters.put(StubApp.getString2(34058), nTRULPRimeParameterSpec5);
        parameters.put(StubApp.getString2(34059), nTRULPRimeParameterSpec6);
    }

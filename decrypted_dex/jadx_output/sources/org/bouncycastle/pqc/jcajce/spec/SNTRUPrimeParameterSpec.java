...
public class SNTRUPrimeParameterSpec implements AlgorithmParameterSpec {
    ...
    static {
        ...
        parameters = hashMap;
        hashMap.put(StubApp.getString2(34060), sNTRUPrimeParameterSpec);
        parameters.put(StubApp.getString2(34061), sNTRUPrimeParameterSpec2);
        parameters.put(StubApp.getString2(34062), sNTRUPrimeParameterSpec3);
        parameters.put(StubApp.getString2(34063), sNTRUPrimeParameterSpec4);
        parameters.put(StubApp.getString2(34064), sNTRUPrimeParameterSpec5);
        parameters.put(StubApp.getString2(34065), sNTRUPrimeParameterSpec6);
    }

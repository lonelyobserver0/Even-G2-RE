...
class Ntt {
    ...
    public static void baseMult(Poly poly, int i3, short s10, short s11, short s12, short s13, short s14) {
        poly.setCoeffIndex(i3, (short) (factorQMulMont(factorQMulMont(s11, s13), s14) + factorQMulMont(s10, s12)));
        poly.setCoeffIndex(i3 + 1, (short) (factorQMulMont(s10, s13) + factorQMulMont(s11, s12)));
    }

    public static short factorQMulMont(short s10, short s11) {
        return Reduce.montgomeryReduce(s10 * s11);
    }
    ...
    public static short[] invNtt(short[] sArr) {
        ...
        for (int i10 = 2; i10 <= 128; i10 <<= 1) {
            ...
            while (i11 < 256) {
                int i12 = i3 + 1;
                short s10 = nttZetasInv[i3];
                int i13 = i11;
                while (i13 < i11 + i10) {
                    short s11 = sArr2[i13];
                    int i14 = i13 + i10;
                    sArr2[i13] = Reduce.barretReduce((short) (sArr2[i14] + s11));
                    short s12 = (short) (s11 - sArr2[i14]);
                    sArr2[i14] = s12;
                    sArr2[i14] = factorQMulMont(s10, s12);
                    i13++;
                }
                i11 = i13 + i10;
                i3 = i12;
        ...
        for (int i15 = 0; i15 < 256; i15++) {
            sArr2[i15] = factorQMulMont(sArr2[i15], nttZetasInv[127]);
        }
        return sArr2;
    }
    ...
    public static short[] ntt(short[] sArr) {
        ...
        for (int i10 = 128; i10 >= 2; i10 >>= 1) {
            ...
            while (i11 < 256) {
                int i12 = i3 + 1;
                short s10 = nttZetas[i3];
                int i13 = i11;
                while (i13 < i11 + i10) {
                    int i14 = i13 + i10;
                    short factorQMulMont = factorQMulMont(s10, sArr2[i14]);
                    sArr2[i14] = (short) (sArr2[i13] - factorQMulMont);
                    sArr2[i13] = (short) (sArr2[i13] + factorQMulMont);
                    i13++;
                }
                i11 = i13 + i10;
                i3 = i12;

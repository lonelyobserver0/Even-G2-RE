...
public class NTRULPRimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRoundedDecodedPolynomial(sArr, nTRULPRimePublicKeyParameters.getRoundEncA(), p8, q10);
        short[] sArr2 = new short[p8];
        Utils.generatePolynomialInRQFromSeed(sArr2, nTRULPRimePublicKeyParameters.getSeed(), p8, q10);
        ...
        Utils.sortGenerateShortPolynomial(bArr3, iArr, p8, w10);
        short[] sArr3 = new short[p8];
        Utils.multiplicationInRQ(sArr3, sArr2, bArr3, p8, q10);
        short[] sArr4 = new short[p8];
        Utils.roundPolynomial(sArr4, sArr3);
        byte[] bArr4 = new byte[roundedPolynomialBytes];
        Utils.getRoundedEncodedPolynomial(bArr4, sArr4, p8, q10);
        short[] sArr5 = new short[p8];
        Utils.multiplicationInRQ(sArr5, sArr, bArr3, p8, q10);

...
public class NTRUKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Polynomial r8 = sampleRm.r();
        Polynomial m4 = sampleRm.m();
        byte[] s3ToBytes = r8.s3ToBytes(nTRUParameterSet.owcpaMsgBytes());
        System.arraycopy(s3ToBytes, 0, bArr, 0, s3ToBytes.length);
        byte[] s3ToBytes2 = m4.s3ToBytes(owcpaMsgBytes - nTRUParameterSet.packTrinaryBytes());
        ...
        r8.z3ToZq();
        byte[] encrypt = ntruowcpa.encrypt(r8, m4, nTRUPublicKeyParameters.publicKey);

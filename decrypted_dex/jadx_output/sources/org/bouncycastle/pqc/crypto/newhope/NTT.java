...
class NTT {
        ...
        for (int i3 = 0; i3 < 10; i3 += 2) {
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (i13 < 1023) {
                    ...
                    int i17 = i12 + 1;
                    short s10 = sArr2[i12];
                    sArr[i13] = (short) (i14 + i16);
                    sArr[i15] = Reduce.montgomery(((i14 + 36867) - i16) * s10);
                    i13 += i10 * 2;
                    i12 = i17;
                }
            }
            ...
            for (int i19 = 0; i19 < i18; i19++) {
                ...
                while (i21 < 1023) {
                    ...
                    int i23 = i21 + i18;
                    int i24 = sArr[i23] & UShort.MAX_VALUE;
                    int i25 = i20 + 1;
                    short s11 = sArr2[i20];
                    sArr[i21] = Reduce.barrett((short) (i22 + i24));
                    sArr[i23] = Reduce.montgomery(((i22 + 36867) - i24) * s11);
                    i21 += i18 * 2;
                    i20 = i25;
                }
            }
    ...
    public static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int i3 = 0; i3 < 1024; i3++) {
            sArr[i3] = Reduce.montgomery((sArr[i3] & UShort.MAX_VALUE) * (65535 & sArr2[i3]));
        }
    }
}

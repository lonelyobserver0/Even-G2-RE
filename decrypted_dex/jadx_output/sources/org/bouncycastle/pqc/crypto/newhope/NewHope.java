...
class NewHope {
    ...
    public static void decodeB(short[] sArr, short[] sArr2, byte[] bArr) {
        ...
        for (int i3 = 0; i3 < 256; i3++) {
            int i10 = i3 * 4;
            byte b2 = bArr[i3 + 1792];
            int i11 = b2 & UByte.MAX_VALUE;
            sArr2[i10] = (short) (b2 & 3);
            sArr2[i10 + 1] = (short) ((i11 >>> 2) & 3);
            sArr2[i10 + 2] = (short) ((i11 >>> 4) & 3);
            sArr2[i10 + 3] = (short) (i11 >>> 6);
        }
    }
    ...
    public static void encodeB(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i3 = 0; i3 < 256; i3++) {
            int i10 = i3 * 4;
            bArr[i3 + 1792] = (byte) ((sArr2[i10 + 3] << 6) | sArr2[i10] | (sArr2[i10 + 1] << 2) | (sArr2[i10 + 2] << 4));
        }
    }

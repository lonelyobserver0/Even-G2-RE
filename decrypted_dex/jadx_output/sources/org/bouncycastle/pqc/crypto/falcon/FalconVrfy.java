...
class FalconVrfy {
    ...
    final int f19392Q = 12289;
    final int Q0I = 12287;

    /* renamed from: R, reason: collision with root package name */
    final int f19393R = 4091;

    /* renamed from: R2, reason: collision with root package name */
    final int f19394R2 = 10952;
    ...
    public int complete_private(byte[] bArr, int i3, byte[] bArr2, int i10, byte[] bArr3, int i11, byte[] bArr4, int i12, int i13, short[] sArr, int i14) {
        int i15 = 1 << i13;
        int i16 = i14 + i15;
        for (int i17 = 0; i17 < i15; i17++) {
            sArr[i14 + i17] = (short) mq_conv_small(bArr3[i11 + i17]);
            sArr[i16 + i17] = (short) mq_conv_small(bArr4[i12 + i17]);
        }
        mq_NTT(sArr, i14, i13);
        mq_NTT(sArr, i16, i13);
        mq_poly_tomonty(sArr, i14, i13);
        mq_poly_montymul_ntt(sArr, i14, sArr, i16, i13);
        for (int i18 = 0; i18 < i15; i18++) {
            sArr[i16 + i18] = (short) mq_conv_small(bArr2[i10 + i18]);
        }
        mq_NTT(sArr, i16, i13);
        for (int i19 = 0; i19 < i15; i19++) {
            short s10 = sArr[i16 + i19];
            if (s10 == 0) {
                return 0;
            }
            int i20 = i14 + i19;
            sArr[i20] = (short) mq_div_12289(sArr[i20], s10);
        }
        mq_iNTT(sArr, i14, i13);
        for (int i21 = 0; i21 < i15; i21++) {
            int i22 = sArr[i14 + i21] & UShort.MAX_VALUE;
            int i23 = i22 - ((~(-((i22 - 6144) >>> 31))) & 12289);
            if (i23 < -127 || i23 > 127) {
                return 0;
            }
            bArr[i3 + i21] = (byte) i23;
        }
        return 1;
    }

    public int compute_public(short[] sArr, int i3, byte[] bArr, int i10, byte[] bArr2, int i11, int i12, short[] sArr2, int i13) {
        int i14 = 1 << i12;
        for (int i15 = 0; i15 < i14; i15++) {
            sArr2[i13 + i15] = (short) mq_conv_small(bArr[i10 + i15]);
            sArr[i3 + i15] = (short) mq_conv_small(bArr2[i11 + i15]);
        }
        mq_NTT(sArr, i3, i12);
        mq_NTT(sArr2, i13, i12);
        for (int i16 = 0; i16 < i14; i16++) {
            short s10 = sArr2[i13 + i16];
            if (s10 == 0) {
                return 0;
            }
            int i17 = i3 + i16;
            sArr[i17] = (short) mq_div_12289(sArr[i17], s10);
        }
        mq_iNTT(sArr, i3, i12);
        return 1;
    }

    public int count_nttzero(short[] sArr, int i3, int i10, short[] sArr2, int i11) {
        int i12 = 1 << i10;
        for (int i13 = 0; i13 < i12; i13++) {
            short s10 = sArr[i3 + i13];
            sArr2[i11 + i13] = (short) (s10 + ((-(s10 >>> 31)) & 12289));
        }
        mq_NTT(sArr2, i11, i10);
        int i14 = 0;
        for (int i15 = 0; i15 < i12; i15++) {
            i14 += ((sArr2[i11 + i15] & UShort.MAX_VALUE) - 1) >>> 31;
        }
        return i14;
    }

    public int is_invertible(short[] sArr, int i3, int i10, short[] sArr2, int i11) {
        int i12 = 1 << i10;
        for (int i13 = 0; i13 < i12; i13++) {
            short s10 = sArr[i3 + i13];
            sArr2[i11 + i13] = (short) (s10 + ((-(s10 >>> 31)) & 12289));
        ...
        int i14 = 0;
        for (int i15 = 0; i15 < i12; i15++) {
            i14 |= (sArr2[i11 + i15] & UShort.MAX_VALUE) - 1;
        }
        return 1 - (i14 >>> 31);
    }

    public void mq_NTT(short[] sArr, int i3, int i10) {
        int i11 = 1;
        int i12 = 1 << i10;
        int i13 = i12;
        while (i11 < i12) {
            ...
            int i16 = 0;
            while (i15 < i11) {
                short s10 = this.GMb[i11 + i15];
                int i17 = i16 + i14;
                for (int i18 = i16; i18 < i17; i18++) {
                    int i19 = i3 + i18;
                    int i20 = sArr[i19] & UShort.MAX_VALUE;
                    int i21 = i19 + i14;
                    int mq_montymul = mq_montymul(sArr[i21], s10);
                    sArr[i19] = (short) mq_add(i20, mq_montymul);
                    sArr[i21] = (short) mq_sub(i20, mq_montymul);
                }
                i15++;
                i16 += i13;
            }
    ...
    public int mq_add(int i3, int i10) {
        int i11 = (i3 + i10) - 12289;
        return i11 + ((-(i11 >>> 31)) & 12289);
    }

    public int mq_conv_small(int i3) {
        return i3 + ((-(i3 >>> 31)) & 12289);
    }

    public int mq_div_12289(int i3, int i10) {
        int mq_montymul = mq_montymul(i10, 10952);
        ...
        return mq_montymul(mq_montymul(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul4)), mq_montymul3))), mq_montymul4)), mq_montymul), i3);
    }

    public void mq_iNTT(short[] sArr, int i3, int i10) {
        int i11;
        int i12 = 1 << i10;
        int i13 = 1;
        int i14 = i12;
        while (true) {
            ...
            while (i11 < i14) {
                int i17 = i16 + i13;
                short s10 = this.iGMb[i14 + i11];
                for (int i18 = i16; i18 < i17; i18++) {
                    int i19 = i3 + i18;
                    int i20 = sArr[i19] & UShort.MAX_VALUE;
                    int i21 = i19 + i13;
                    int i22 = 65535 & sArr[i21];
                    sArr[i19] = (short) mq_add(i20, i22);
                    sArr[i21] = (short) mq_montymul(mq_sub(i20, i22), s10);
                }
                i11++;
                i16 += i15;
            }
        ...
        int i23 = 4091;
        for (int i24 = i12; i24 > 1; i24 >>= 1) {
            i23 = mq_rshift1(i23);
        }
        while (i11 < i12) {
            int i25 = i3 + i11;
            sArr[i25] = (short) mq_montymul(sArr[i25], i23);
            i11++;
        }
    }

    public int mq_montymul(int i3, int i10) {
        int i11 = i3 * i10;
        int i12 = (((((i11 * 12287) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) * 12289) + i11) >>> 16) - 12289;
        return i12 + ((-(i12 >>> 31)) & 12289);
    }

    public int mq_montysqr(int i3) {
        return mq_montymul(i3, i3);
    }

    public void mq_poly_montymul_ntt(short[] sArr, int i3, short[] sArr2, int i10, int i11) {
        int i12 = 1 << i11;
        for (int i13 = 0; i13 < i12; i13++) {
            int i14 = i3 + i13;
            sArr[i14] = (short) mq_montymul(sArr[i14], sArr2[i10 + i13]);
        }
    }

    public void mq_poly_sub(short[] sArr, int i3, short[] sArr2, int i10, int i11) {
        int i12 = 1 << i11;
        for (int i13 = 0; i13 < i12; i13++) {
            int i14 = i3 + i13;
            sArr[i14] = (short) mq_sub(sArr[i14], sArr2[i10 + i13]);
        }
    }

    public void mq_poly_tomonty(short[] sArr, int i3, int i10) {
        int i11 = 1 << i10;
        for (int i12 = 0; i12 < i11; i12++) {
            int i13 = i3 + i12;
            sArr[i13] = (short) mq_montymul(sArr[i13], 10952);
        }
    }

    public int mq_rshift1(int i3) {
        return (i3 + ((-(i3 & 1)) & 12289)) >>> 1;
    }

    public int mq_sub(int i3, int i10) {
        int i11 = i3 - i10;
        return i11 + ((-(i11 >>> 31)) & 12289);
    }

    public void to_ntt_monty(short[] sArr, int i3, int i10) {
        mq_NTT(sArr, i3, i10);
        mq_poly_tomonty(sArr, i3, i10);
    }

    public int verify_raw(short[] sArr, int i3, short[] sArr2, int i10, short[] sArr3, int i11, int i12, short[] sArr4, int i13) {
        int i14 = 1 << i12;
        for (int i15 = 0; i15 < i14; i15++) {
            short s10 = sArr2[i10 + i15];
            sArr4[i13 + i15] = (short) (s10 + ((-(s10 >>> 31)) & 12289));
        }
        mq_NTT(sArr4, i13, i12);
        mq_poly_montymul_ntt(sArr4, i13, sArr3, i11, i12);
        mq_iNTT(sArr4, i13, i12);
        mq_poly_sub(sArr4, i13, sArr, i3, i12);
        for (int i16 = 0; i16 < i14; i16++) {
            int i17 = i13 + i16;
            int i18 = sArr4[i17] & UShort.MAX_VALUE;
            sArr4[i17] = (short) (i18 - ((-((6144 - i18) >>> 31)) & 12289));
        }
        return this.common.is_short(sArr4, i13, sArr2, i10, i12);
    }

    public int verify_recover(short[] sArr, int i3, short[] sArr2, int i10, short[] sArr3, int i11, short[] sArr4, int i12, int i13, short[] sArr5, int i14) {
        int i15 = 1 << i13;
        for (int i16 = 0; i16 < i15; i16++) {
            short s10 = sArr4[i12 + i16];
            sArr5[i14 + i16] = (short) (s10 + ((-(s10 >> 31)) & 12289));
            short s11 = sArr3[i11 + i16];
            sArr[i3 + i16] = (short) mq_sub(sArr2[i10 + i16], 65535 & (s11 + ((-(s11 >>> 31)) & 12289)));
        }
        mq_NTT(sArr5, i14, i13);
        mq_NTT(sArr5, i3, i13);
        int i17 = 0;
        for (int i18 = 0; i18 < i15; i18++) {
            short s12 = sArr5[i14 + i18];
            i17 |= (s12 & UShort.MAX_VALUE) - 1;
            int i19 = i3 + i18;
            sArr[i19] = (short) mq_div_12289(sArr[i19] & UShort.MAX_VALUE, s12 & UShort.MAX_VALUE);
        }
        mq_iNTT(sArr, i3, i13);
        return ((~i17) & (-this.common.is_short(sArr3, i11, sArr4, i12, i13))) >>> 31;
    }
}

...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        private GF2Matrix f19568h;

        /* renamed from: p, reason: collision with root package name */
        private Permutation f19569p;

        /* renamed from: s, reason: collision with root package name */
        private GF2Matrix f19570s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f19570s = gF2Matrix;
            this.f19568h = gF2Matrix2;
            this.f19569p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        private GF2Matrix f19571g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f19571g = gF2Matrix;
            this.setJ = iArr;
        }

...
public class PolynomialGF2mSmallM {
    ...
    private int[] modKaratsubaMultiplyBigDeg(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (true) {
            ...
            for (int i15 = 0; i15 < Math.min(length2, i14) && i15 < (i10 = i14 - i15); i15++) {
                int i16 = iArr4[i15];
                int i17 = i10 < iArr4.length ? iArr4[i10] : 0;
                int i18 = clone[i15];
                int i19 = iArr5[i15];
                if (i10 < length2 && i15 < length2) {
                    int i20 = clone[i10];
                    int i21 = iArr5[i10];
                    iArr6[i14] = ((i18 + i20) * (i16 + i17)) + iArr6[i14];
                    iArr7[i14] = iArr7[i14] + i19 + i21;
                } else if (i10 >= length2 && i10 < length) {
                    iArr6[i14] = ((i16 + i17) * i18) + iArr6[i14];
                    iArr7[i14] = iArr7[i14] + i19;
                }
            }
            i14++;
        }
        for (int i22 = 0; i22 < i12; i22++) {
            if (i22 == 0) {
                iArr8[i22] = iArr5[i22] % 2;
            } else if (i22 == i3) {
                iArr8[i22] = (iArr4[iArr4.length - 1] * clone[clone.length - 1]) % 2;
            } else if (i22 % 2 == 1) {
                iArr8[i22] = (iArr6[i22] - iArr7[i22]) % 2;
            } else {
                iArr8[i22] = ((iArr6[i22] - iArr7[i22]) + iArr5[i22 / 2]) % 2;
            }
        }

...
public class PolynomialRingGF2m {
    ...
    private PolynomialGF2mSmallM f19572p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f19572p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f19572p.getDegree();
    ...
    private void computeSquaringMatrix() {
        ...
        while (i3 < degree) {
            ...
            iArr2[i12] = 1;
            this.sqMatrix[i3] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f19572p);
            i3++;
        }
    }

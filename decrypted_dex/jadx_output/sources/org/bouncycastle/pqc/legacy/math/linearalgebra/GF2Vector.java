...
public class GF2Vector extends Vector {
    ...
    public Vector add(Vector vector) {
        ...
        int[] clone = IntUtils.clone(gF2Vector.f19557v);
        for (int length = clone.length - 1; length >= 0; length--) {
            clone[length] = clone[length] ^ this.f19557v[length];
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f19557v, gF2Vector.f19557v);
    }
    ...
    public GF2Vector extractLeftVector(int i3) {
        ...
        int i11 = i3 >> 5;
        int i12 = i3 & 31;
        System.arraycopy(this.f19557v, 0, gF2Vector.f19557v, 0, i11);
        if (i12 != 0) {
            gF2Vector.f19557v[i11] = ((1 << i12) - 1) & this.f19557v[i11];
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i3) {
        ...
        int i16 = 0;
        if (i14 == 0) {
            System.arraycopy(this.f19557v, i13, gF2Vector.f19557v, 0, i15);
            return gF2Vector;
        }
        while (true) {
            i10 = i15 - 1;
            ...
            int[] iArr = gF2Vector.f19557v;
            int[] iArr2 = this.f19557v;
            int i17 = i13 + 1;
            iArr[i16] = (iArr2[i13] >>> i14) | (iArr2[i17] << (32 - i14));
            i16++;
            i13 = i17;
        }
        int[] iArr3 = gF2Vector.f19557v;
        int[] iArr4 = this.f19557v;
        int i18 = i13 + 1;
    ...
    public int getBit(int i3) {
        ...
        int i10 = i3 >> 5;
        int i11 = i3 & 31;
        return (this.f19557v[i10] & (1 << i11)) >>> i11;
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f19557v, (this.length + 7) >> 3);
    }
    ...
    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public int hashCode() {
        return Arrays.hashCode(this.f19557v) + (this.length * 31);
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f19557v.length - 1; length >= 0; length--) {
            if (this.f19557v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public GF2mVector toExtensionFieldVector(GF2mField gF2mField) {
        ...
        for (int i12 = i10 - 1; i12 >= 0; i12--) {
            for (int degree2 = gF2mField.getDegree() - 1; degree2 >= 0; degree2--) {
                if (((this.f19557v[i11 >>> 5] >>> (i11 & 31)) & 1) == 1) {
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < this.length; i3++) {
            ...
            stringBuffer.append((this.f19557v[i3 >> 5] & (1 << (i3 & 31))) == 0 ? '0' : '1');
        }
    ...
    public GF2Vector(int i3, SecureRandom secureRandom) {
        this.length = i3;
        int i10 = (i3 + 31) >> 5;
        this.f19557v = new int[i10];
        int i11 = i10 - 1;
        for (int i12 = i11; i12 >= 0; i12--) {
            this.f19557v[i12] = secureRandom.nextInt();
        }
        int i13 = i3 & 31;
        if (i13 != 0) {
            int[] iArr = this.f19557v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f19557v = IntUtils.clone(gF2Vector.f19557v);
    }

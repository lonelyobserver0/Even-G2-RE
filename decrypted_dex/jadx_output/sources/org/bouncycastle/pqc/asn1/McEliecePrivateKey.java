...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public McEliecePrivateKey(int i3, int i10, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, Permutation permutation2, GF2Matrix gF2Matrix) {
        this.f19341n = i3;
        this.f19340k = i10;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f19341n));
        aSN1EncodableVector.add(new ASN1Integer(this.f19340k));
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f19341n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f19340k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();

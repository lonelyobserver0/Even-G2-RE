...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public McElieceCCA2PrivateKey(int i3, int i10, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, AlgorithmIdentifier algorithmIdentifier) {
        this.f19336n = i3;
        this.f19335k = i10;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f19336n));
        aSN1EncodableVector.add(new ASN1Integer(this.f19335k));
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f19336n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f19335k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();

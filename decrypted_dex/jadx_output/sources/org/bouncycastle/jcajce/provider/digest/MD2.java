...
public class MD2 {
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        public KeyGenerator() {
            super(StubApp.getString2(31053), 128, new CipherKeyGenerator());
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm(StubApp.getString2(31054), sb2.toString());
            ...
            String string2 = StubApp.getString2(28179);

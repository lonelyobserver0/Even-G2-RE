...
public class GMCipherSpi extends CipherSpi {
    ...
    public int engineGetOutputSize(int i3) {
        ...
        if (i10 == 1 || i10 == 3 || i10 == 2 || i10 == 4) {
            return this.engine.getOutputSize(i3);
        }
    ...
    public void engineInit(int i3, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (algorithmParameters == null) {
            ...
            throw new InvalidAlgorithmParameterException(StubApp.getString2(30503).concat(algorithmParameters.getClass().getName()));
        }
    }

    @Override // javax.crypto.CipherSpi
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        if (!Strings.toUpperCase(str).equals(StubApp.getString2(207))) {
    ...
    public void engineSetPadding(String str) throws NoSuchPaddingException {
        if (!Strings.toUpperCase(str).equals(StubApp.getString2(30513))) {
    ...
    public void engineInit(int i3, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException, InvalidKeyException {
        ...
        if (i3 == 1 || i3 == 3) {
            if (!(key instanceof PublicKey)) {
                throw new InvalidKeyException(StubApp.getString2(30606));
            }
            ...
            if (!(key instanceof PrivateKey)) {
                throw new InvalidKeyException(StubApp.getString2(30605));
            }

...
public class BCDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public String toString() {
        StringBuffer stringBuffer = new StringBuffer(StubApp.getString2(30574));
        String lineSeparator = Strings.lineSeparator();
        BigInteger modPow = getParams().getG().modPow(this.f19129x, getParams().getP());
    ...
    public BCDSAPrivateKey(DSAPrivateKey dSAPrivateKey) {
        this.f19129x = dSAPrivateKey.getX();
        this.dsaSpec = dSAPrivateKey.getParams();
    }

    public BCDSAPrivateKey(DSAPrivateKeySpec dSAPrivateKeySpec) {
        this.f19129x = dSAPrivateKeySpec.getX();
    ...
    public BCDSAPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f19129x = ((ASN1Integer) privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public BCDSAPrivateKey(DSAPrivateKeyParameters dSAPrivateKeyParameters) {
        this.f19129x = dSAPrivateKeyParameters.getX();

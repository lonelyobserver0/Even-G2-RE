...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof PKCS8EncodedKeySpec) {
            try {
                ...
                try {
                    ...
                    throw new ExtendedInvalidKeySpecException(a.b(e10, new StringBuilder(StubApp.getString2(30815))), e10);
                }
            }
        }
        ...
        if (!(keySpec instanceof OpenSSHPrivateKeySpec)) {
            throw new InvalidKeySpecException(StubApp.getString2(30817).concat(keySpec.getClass().getName()));
        }
        ...
        throw new InvalidKeySpecException(StubApp.getString2(30816));
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException(StubApp.getString2(30818));
    }
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        String string2 = StubApp.getString2(30586);
        if (isAssignableFrom && (key instanceof RSAPublicKey)) {
            try {

...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class PSS extends KeyPairGeneratorSpi {
        public PSS() {
            super(StubApp.getString2(30368), KeyPairGeneratorSpi.PSS_ALGID);
        }
    }

    public KeyPairGeneratorSpi() {
        this(StubApp.getString2(24659), PKCS_ALGID);
    }
    ...
    public void initialize(int i3, SecureRandom secureRandom) {
        RSAKeyGenerationParameters rSAKeyGenerationParameters = new RSAKeyGenerationParameters(defaultPublicExponent, secureRandom, i3, PrimeCertaintyCalculator.getDefaultCertainty(i3));
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        if (!(algorithmParameterSpec instanceof RSAKeyGenParameterSpec)) {
            throw new InvalidAlgorithmParameterException(StubApp.getString2(30819));
        }

...
public class ECUtil {
    ...
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey privateKey) throws InvalidKeyException {
        ...
        try {
            ...
            if (encoded == null) {
                throw new InvalidKeyException(StubApp.getString2("30857"));
            }
            PrivateKey privateKey2 = BouncyCastleProvider.getPrivateKey(PrivateKeyInfo.getInstance(encoded));
            if (privateKey2 instanceof java.security.interfaces.ECPrivateKey) {
                return generatePrivateKeyParameter(privateKey2);
            }
            throw new InvalidKeyException(StubApp.getString2(30856));
        } catch (Exception e10) {
            throw new InvalidKeyException(a.b(e10, new StringBuilder(StubApp.getString2(30858))));
        }
    }
    ...
    public static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey publicKey) throws InvalidKeyException {
        ...
        try {
            ...
            if (encoded == null) {
                throw new InvalidKeyException(StubApp.getString2("30860"));
            }
            PublicKey publicKey2 = BouncyCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(encoded));
            if (publicKey2 instanceof java.security.interfaces.ECPublicKey) {
                return generatePublicKeyParameter(publicKey2);
            }
            throw new InvalidKeyException(StubApp.getString2(30859));
        } catch (Exception e10) {
            throw new InvalidKeyException(a.b(e10, new StringBuilder(StubApp.getString2(30861))));
        }
    }
    ...
    public static String getNameFrom(final AlgorithmParameterSpec algorithmParameterSpec) {
        return (String) AccessController.doPrivileged(new PrivilegedAction() { // from class: org.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.1
            ...
            public Object run() {
                try {
                    return algorithmParameterSpec.getClass().getMethod(StubApp.getString2("10848"), new Class[0]).invoke(algorithmParameterSpec, new Object[0]);

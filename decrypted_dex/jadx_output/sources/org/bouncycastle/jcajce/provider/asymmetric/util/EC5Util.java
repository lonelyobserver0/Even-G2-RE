...
public class EC5Util {
    ...
    public static class CustomCurves {
        ...
        private static Map createCurveMap() {
            ...
            ECCurve curve2 = CustomNamedCurves.getByNameLazy(StubApp.getString2(30852)).getCurve();
    ...
    public static ECCurve getCurve(ProviderConfiguration providerConfiguration, X962Parameters x962Parameters) {
        ...
        if (!x962Parameters.isNamedCurve()) {
            ...
            throw new IllegalStateException(StubApp.getString2(30854));
        }
        ASN1ObjectIdentifier aSN1ObjectIdentifier = ASN1ObjectIdentifier.getInstance(x962Parameters.getParameters());
        if (!acceptableNamedCurves.isEmpty() && !acceptableNamedCurves.contains(aSN1ObjectIdentifier)) {
            throw new IllegalStateException(StubApp.getString2(30853));
        }
        X9ECParameters namedCurveByOid = ECUtil.getNamedCurveByOid(aSN1ObjectIdentifier);
        if (namedCurveByOid == null) {
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            return CustomCurves.substitute(new ECCurve.Fp(((ECFieldFp) field).getP(), a3, b2));
        }
        ECFieldF2m eCFieldF2m = (ECFieldF2m) field;
        int m4 = eCFieldF2m.getM();
        int[] convertMidTerms = ECUtil.convertMidTerms(eCFieldF2m.getMidTermsOfReductionPolynomial());
        return new ECCurve.F2m(m4, convertMidTerms[0], convertMidTerms[1], convertMidTerms[2], a3, b2);
    }

...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        if (this.gost3410Spec.getPublicKeyParamSetOID() != null) {
            a3 = this.gost3410Spec.getPublicKeyParamSetOID();
        } else {
            ...
            a3 = this.gost3410Spec.getPublicKeyParameters().getA();
        }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCGOST3410PublicKey) {
            ...
            if (this.f19139y.equals(bCGOST3410PublicKey.f19139y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec)) {
                return true;
            }
        }
        return false;
    ...
    public String getAlgorithm() {
        return StubApp.getString2(28165);
    }
    ...
    public int hashCode() {
        return this.f19139y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString(StubApp.getString2("28165"), this.f19139y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
    ...
    public BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f19139y = new BigInteger(1, bArr);
            this.gost3410Spec = GOST3410ParameterSpec.fromPublicKeyAlg(gOST3410PublicKeyAlgParameters);
        } catch (IOException unused) {
            throw new IllegalArgumentException(StubApp.getString2(30767));
        }
    }
    ...
    public BCGOST3410PublicKey(GOST3410PublicKeyParameters gOST3410PublicKeyParameters, GOST3410ParameterSpec gOST3410ParameterSpec) {
        this.f19139y = gOST3410PublicKeyParameters.getY();
        this.gost3410Spec = gOST3410ParameterSpec;
    }

    public BCGOST3410PublicKey(GOST3410PublicKey gOST3410PublicKey) {
        this.f19139y = gOST3410PublicKey.getY();
        this.gost3410Spec = gOST3410PublicKey.getParameters();
    }

    public BCGOST3410PublicKey(GOST3410PublicKeySpec gOST3410PublicKeySpec) {
        this.f19139y = gOST3410PublicKeySpec.getY();

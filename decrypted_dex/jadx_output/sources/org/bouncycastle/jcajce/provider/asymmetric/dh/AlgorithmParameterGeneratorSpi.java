...
public class AlgorithmParameterGeneratorSpi extends BaseAlgorithmParameterGeneratorSpi {
    ...
    public AlgorithmParameters engineGenerateParameters() {
        ...
        try {
            AlgorithmParameters createParametersInstance = createParametersInstance(StubApp.getString2("28348"));
            createParametersInstance.init(new DHParameterSpec(generateParameters.getP(), generateParameters.getG(), this.f19123l));
    ...
    public void engineInit(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        this.f19123l = dHGenParameterSpec.getExponentSize();
        this.random = secureRandom;
    }
}

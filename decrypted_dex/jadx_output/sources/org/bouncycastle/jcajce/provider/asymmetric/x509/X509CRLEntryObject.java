...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f19140c.equals(x509CRLEntryObject.f19140c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f19140c.getEncoded(StubApp.getString2("26791"));
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new IllegalStateException(a.b(e10, new StringBuilder(StubApp.getString2(30888))));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f19140c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f19140c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f19140c.getExtensions() != null;
    }

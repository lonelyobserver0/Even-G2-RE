...
public class DSAUtil {
    ...
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey privateKey) throws InvalidKeyException {
        if (!(privateKey instanceof DSAPrivateKey)) {
            throw new InvalidKeyException(StubApp.getString2(30581));
        }
    ...
    public static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey publicKey) throws InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(StubApp.getString2(30582).concat(publicKey.getClass().getName()));
        }
    }
    ...
    public static boolean isDsaOid(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        while (true) {
            ...
            if (aSN1ObjectIdentifier.equals((ASN1Primitive) aSN1ObjectIdentifierArr[i3])) {
                return true;
            }
            i3++;
        }

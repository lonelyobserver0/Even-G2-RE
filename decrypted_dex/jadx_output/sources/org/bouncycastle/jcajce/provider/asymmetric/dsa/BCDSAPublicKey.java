...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    public BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f19130y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f19130y, DSAUtil.toDSAParameters(this.dsaSpec));
    }
    ...
    public byte[] getEncoded() {
        DSAParams dSAParams = this.dsaSpec;
        return dSAParams == null ? KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(this.f19130y)) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, new DSAParameter(dSAParams.getP(), this.dsaSpec.getQ(), this.dsaSpec.getG()).toASN1Primitive()), new ASN1Integer(this.f19130y));
    }
    ...
    public String toString() {
        StringBuffer stringBuffer = new StringBuffer(StubApp.getString2(30577));
        String lineSeparator = Strings.lineSeparator();
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f19130y, getParams()));
    ...
    public BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f19130y = dSAPublicKeySpec.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f19130y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f19130y = dSAPublicKeyParameters.getY();

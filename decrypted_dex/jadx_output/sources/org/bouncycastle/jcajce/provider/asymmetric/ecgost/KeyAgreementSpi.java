...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public static class ECVKO extends KeyAgreementSpi {
        public ECVKO() {
            super(StubApp.getString2(28166), new ECVKOAgreement(new GOST3411Digest()), null);
        }
    }
    ...
    public Key engineDoPhase(Key key, boolean z2) throws InvalidKeyException, IllegalStateException {
        ...
        try {
            ...
            throw new InvalidKeyException(u.r(e10, new StringBuilder(StubApp.getString2(30657)))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi.1

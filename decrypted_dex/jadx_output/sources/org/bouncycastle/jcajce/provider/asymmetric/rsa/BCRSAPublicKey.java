...
public class BCRSAPublicKey implements RSAPublicKey {
    ...
    public String getAlgorithm() {
        return this.algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_RSASSA_PSS) ? StubApp.getString2(30368) : StubApp.getString2(24659);
    }
    ...
    public String toString() {
        StringBuffer stringBuffer = new StringBuffer(StubApp.getString2(30794));
        String lineSeparator = Strings.lineSeparator();
        stringBuffer.append(RSAUtil.generateKeyFingerprint(getModulus()));
        stringBuffer.append(StubApp.getString2(30787));
        ...
        stringBuffer.append(StubApp.getString2(30795));
        stringBuffer.append(getModulus().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append(StubApp.getString2(30796));

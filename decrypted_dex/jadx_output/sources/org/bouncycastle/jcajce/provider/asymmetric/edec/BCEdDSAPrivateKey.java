...
public class BCEdDSAPrivateKey implements EdDSAPrivateKey {
    ...
    public String getAlgorithm() {
        return this.eddsaPrivateKey instanceof Ed448PrivateKeyParameters ? StubApp.getString2(28197) : StubApp.getString2(28196);
    }
    ...
    public byte[] getEncoded() {
        try {
            ...
            return (!this.hasPublicKey || Properties.isOverrideSet(StubApp.getString2("30673"))) ? new PrivateKeyInfo(createPrivateKeyInfo.getPrivateKeyAlgorithm(), createPrivateKeyInfo.parsePrivateKey(), aSN1Set).getEncoded() : createPrivateKeyInfo.getEncoded();
    ...
    public String toString() {
        AsymmetricKeyParameter asymmetricKeyParameter = this.eddsaPrivateKey;
        return Utils.keyToString(StubApp.getString2(30674), getAlgorithm(), asymmetricKeyParameter instanceof Ed448PrivateKeyParameters ? ((Ed448PrivateKeyParameters) asymmetricKeyParameter).generatePublicKey() : ((Ed25519PrivateKeyParameters) asymmetricKeyParameter).generatePublicKey());
    }

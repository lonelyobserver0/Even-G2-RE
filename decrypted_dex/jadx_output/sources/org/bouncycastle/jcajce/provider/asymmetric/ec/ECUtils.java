...
class ECUtils {
    ...
    public static X962Parameters getDomainParametersFromName(ECParameterSpec eCParameterSpec, boolean z2) {
        if (!(eCParameterSpec instanceof ECNamedCurveSpec)) {
            ...
            return new X962Parameters(new X9ECParameters(convertCurve, new X9ECPoint(EC5Util.convertPoint(convertCurve, eCParameterSpec.getGenerator()), z2), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed()));
        }

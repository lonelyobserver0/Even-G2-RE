...
public abstract class ASN1IA5String extends ASN1Primitive implements ASN1String {
    ...
    public ASN1IA5String(String str, boolean z2) {
        if (str == null) {
            throw new NullPointerException(StubApp.getString2(26705));
        }
        if (z2 && !isIA5String(str)) {
            throw new IllegalArgumentException(StubApp.getString2(26755));
        }
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z2) throws IOException {
        aSN1OutputStream.writeEncodingDL(z2, 22, this.contents);
    }
    ...
    public ASN1IA5String(byte[] bArr, boolean z2) {
        this.contents = z2 ? Arrays.clone(bArr) : bArr;
    }

    public static ASN1IA5String getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
        return (ASN1IA5String) TYPE.getContextInstance(aSN1TaggedObject, z2);
    }
}

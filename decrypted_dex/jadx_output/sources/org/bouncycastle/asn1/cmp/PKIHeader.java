...
public class PKIHeader extends ASN1Object {
    ...
    public PKIHeader(int i3, GeneralName generalName, GeneralName generalName2) {
        this(new ASN1Integer(i3), generalName, generalName2);
    }
    ...
    public InfoTypeAndValue[] getGeneralInfo() {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            infoTypeAndValueArr[i3] = InfoTypeAndValue.getInstance(this.generalInfo.getObjectAt(i3));
        }

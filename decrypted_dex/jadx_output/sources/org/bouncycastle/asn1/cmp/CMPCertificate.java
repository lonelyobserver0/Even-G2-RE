...
public class CMPCertificate extends ASN1Object implements ASN1Choice {
    ...
    public CMPCertificate(int i3, ASN1Object aSN1Object) {
        this.otherTagValue = i3;
    ...
    public static CMPCertificate getInstance(Object obj) {
        ...
        if (obj instanceof byte[]) {
            try {
                ...
                throw new IllegalArgumentException(StubApp.getString2(26878));
            }
        }
    ...
    public CMPCertificate(Certificate certificate) {
        if (certificate.getVersionNumber() != 3) {
            throw new IllegalArgumentException(StubApp.getString2(26877));
        }
        this.x509v3PKCert = certificate;
    }

    public static CMPCertificate getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {

...
public class PKIBody extends ASN1Object implements ASN1Choice {
    ...
    public PKIBody(int i3, ASN1Encodable aSN1Encodable) {
        this.tagNo = i3;
        this.body = getBodyForType(i3, aSN1Encodable);
    }

    private static ASN1Encodable getBodyForType(int i3, ASN1Encodable aSN1Encodable) {
        switch (i3) {
            case 0:
            ...
            default:
                throw new IllegalArgumentException(u.p(i3, StubApp.getString2(26896)));
        }
    }

...
public class PBMParameter extends ASN1Object {
    ...
    public PBMParameter(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, int i3, AlgorithmIdentifier algorithmIdentifier2) {
        this(new DEROctetString(bArr), algorithmIdentifier, new ASN1Integer(i3), algorithmIdentifier2);
    }
}

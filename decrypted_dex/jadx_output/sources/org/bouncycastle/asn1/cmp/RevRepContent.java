...
public class RevRepContent extends ASN1Object {
    ...
    public CertificateList[] getCrls() {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            certificateListArr[i3] = CertificateList.getInstance(this.crls.getObjectAt(i3));
        }
    ...
    public CertId[] getRevCerts() {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            certIdArr[i3] = CertId.getInstance(this.revCerts.getObjectAt(i3));
        }
        return certIdArr;
    }
    ...
    public PKIStatusInfo[] getStatus() {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            pKIStatusInfoArr[i3] = PKIStatusInfo.getInstance(this.status.getObjectAt(i3));
        }

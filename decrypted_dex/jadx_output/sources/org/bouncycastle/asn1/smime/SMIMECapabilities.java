...
public class SMIMECapabilities extends ASN1Object {
    ...
    public static final ASN1ObjectIdentifier idea_CBC = new ASN1ObjectIdentifier(StubApp.getString2(27377));
    public static final ASN1ObjectIdentifier cast5_CBC = new ASN1ObjectIdentifier(StubApp.getString2(27378));
    public static final ASN1ObjectIdentifier dES_CBC = new ASN1ObjectIdentifier(StubApp.getString2(27379));

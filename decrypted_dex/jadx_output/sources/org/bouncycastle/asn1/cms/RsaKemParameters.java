...
public class RsaKemParameters extends ASN1Object {
    ...
    private RsaKemParameters(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 2) {
            throw new IllegalArgumentException(StubApp.getString2(26916));
        }
    ...
    public RsaKemParameters(AlgorithmIdentifier algorithmIdentifier, int i3) {
        this.keyDerivationFunction = algorithmIdentifier;
        this.keyLength = BigInteger.valueOf(i3);
    }
}

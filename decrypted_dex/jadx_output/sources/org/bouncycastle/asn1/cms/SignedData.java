...
public class SignedData extends ASN1Object {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1Primitive instanceof ASN1TaggedObject) {
                ...
                if (tagNo == 0) {
                    ...
                    if (tagNo != 1) {
                        throw new IllegalArgumentException(a.l(aSN1TaggedObject, new StringBuilder(StubApp.getString2(26928))));
                    }
                ...
                if (!(aSN1Primitive instanceof ASN1Set)) {
                    throw new IllegalArgumentException(StubApp.getString2(26929));
                }
                aSN1Set = (ASN1Set) aSN1Primitive;
            }
        }
        if (aSN1Set == null) {
            throw new IllegalArgumentException(StubApp.getString2(26930));
        }
    ...
    private ASN1Integer calculateVersion(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Set aSN1Set, ASN1Set aSN1Set2, ASN1Set aSN1Set3) {
        ...
        if (!z10 && !checkForVersion3(aSN1Set3) && CMSObjectIdentifiers.data.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
            return VERSION_1;
        }
        return VERSION_3;
    }

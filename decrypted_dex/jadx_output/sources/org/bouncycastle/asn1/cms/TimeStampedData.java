...
public class TimeStampedData extends ASN1Object {
    ...
    private TimeStampedData(ASN1Sequence aSN1Sequence) {
        ...
        if ((aSN1Sequence.getObjectAt(i3) instanceof MetaData) || (aSN1Sequence.getObjectAt(i3) instanceof ASN1Sequence)) {
            this.metaData = MetaData.getInstance(aSN1Sequence.getObjectAt(i3));
            i3++;
        }
        ...
        this.temporalEvidence = Evidence.getInstance(aSN1Sequence.getObjectAt(i3));
    }
}

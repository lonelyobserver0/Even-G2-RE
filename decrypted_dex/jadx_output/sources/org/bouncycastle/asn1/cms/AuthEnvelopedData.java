...
public class AuthEnvelopedData extends ASN1Object {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (!aSN1Integer.hasValue(0)) {
            throw new IllegalArgumentException(StubApp.getString2(26905));
        }
        ...
        if (aSN1Set2.size() == 0) {
            throw new IllegalArgumentException(StubApp.getString2(26904));
        }
        this.authEncryptedContentInfo = EncryptedContentInfo.getInstance(aSN1Sequence.getObjectAt(i3).toASN1Primitive());
        int i10 = i3 + 2;
        ASN1Primitive aSN1Primitive2 = aSN1Sequence.getObjectAt(i3 + 1).toASN1Primitive();
        if (aSN1Primitive2 instanceof ASN1TaggedObject) {
            ...
            throw new IllegalArgumentException(StubApp.getString2(26903));
        }
        this.mac = ASN1OctetString.getInstance(aSN1Primitive2);
        if (aSN1Sequence.size() > i10) {
            this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i10).toASN1Primitive(), false);
        }
    }

...
public class SignatureCheck extends ASN1Object {
    ...
    private SignatureCheck(ASN1Sequence aSN1Sequence) {
        ...
        this.signatureValue = DERBitString.getInstance((Object) aSN1Sequence.getObjectAt(i3));
    }
    ...
    public Certificate[] getCertificates() {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            certificateArr[i3] = Certificate.getInstance(this.certificates.getObjectAt(i3));
        }

...
public class CertificateHolderReference {
    private static final String ReferenceEncoding = StubApp.getString2(2882);
    ...
    public byte[] getEncoded() {
        try {
            return (this.countryCode + this.holderMnemonic + this.sequenceNumber).getBytes(StubApp.getString2("2882"));
    ...
    public CertificateHolderReference(byte[] bArr) {
        try {
            String str = new String(bArr, StubApp.getString2("2882"));

...
public class CVCertificateRequest extends ASN1Object {
    ...
    private void initCertBody(ASN1ApplicationSpecific aSN1ApplicationSpecific) throws IOException {
        if (aSN1ApplicationSpecific.getApplicationTag() != 33) {
            throw new IOException(StubApp.getString2(27063) + aSN1ApplicationSpecific.getApplicationTag());
        }
        ...
        while (objects.hasMoreElements()) {
            ...
            if (applicationTag == 55) {
                ...
                if (applicationTag != 78) {
                    throw new IOException(StubApp.getString2(27061) + aSN1ApplicationSpecific2.getApplicationTag());
                }
        ...
        throw new IOException(StubApp.getString2(27062) + aSN1ApplicationSpecific.getApplicationTag());
    }

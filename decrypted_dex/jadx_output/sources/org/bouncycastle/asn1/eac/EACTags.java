...
public class EACTags {
    ...
    public static int decodeTag(int i3) {
        int i10 = 0;
        boolean z2 = false;
        for (int i11 = 24; i11 >= 0; i11 -= 8) {
            ...
            if ((i12 & 255) != 0) {
                if (z2) {
                    i10 = (i10 << 7) | (i12 & CertificateBody.profileType);
                } else {
                    int i13 = i12 & 31;
                    if (i13 != 31) {
                        return i13;
    ...
    public static int encodeTag(ASN1ApplicationSpecific aSN1ApplicationSpecific) {
        int i3 = aSN1ApplicationSpecific.isConstructed() ? 96 : 64;
        int applicationTag = aSN1ApplicationSpecific.getApplicationTag();
        if (applicationTag <= 31) {
            return applicationTag | i3;
        }
        int i10 = i3 | 31;
        while (true) {
            int i11 = (i10 << 8) | (applicationTag & CertificateBody.profileType);
            applicationTag >>= 7;
            if (applicationTag <= 0) {
                return i11;
            }
    ...
    public static int getTag(int i3) {
        return decodeTag(i3);
    }

    public static int getTagNo(int i3) {

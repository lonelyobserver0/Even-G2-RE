...
public class PrivateKeyInfo extends ASN1Object {
    ...
    private PrivateKeyInfo(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo <= i3) {
                throw new IllegalArgumentException(StubApp.getString2(27171));
            }
            if (tagNo == 0) {
                this.attributes = ASN1Set.getInstance(aSN1TaggedObject, false);
            } else {
                if (tagNo != 1) {
                    throw new IllegalArgumentException(StubApp.getString2(27170));
                }
                if (versionValue < 1) {
                    throw new IllegalArgumentException(StubApp.getString2(27169));
                }
    ...
    private static int getVersionValue(ASN1Integer aSN1Integer) {
        ...
        if (intValueExact < 0 || intValueExact > 1) {
            throw new IllegalArgumentException(StubApp.getString2(27172));
        }

...
public class DeclarationOfMajority extends ASN1Object implements ASN1Choice {
    ...
    public DeclarationOfMajority(int i3) {
        this.declaration = new DERTaggedObject(false, 0, (ASN1Encodable) new ASN1Integer(i3));
    }
    ...
    private DeclarationOfMajority(ASN1TaggedObject aSN1TaggedObject) {
        if (aSN1TaggedObject.getTagNo() > 2) {
            throw new IllegalArgumentException(org.bouncycastle.asn1.a.l(aSN1TaggedObject, new StringBuilder(StubApp.getString2(27122))));
        }
    ...
    public DeclarationOfMajority(boolean z2, String str) {
        if (str.length() > 2) {
            throw new IllegalArgumentException(StubApp.getString2(27124));
        }
        if (z2) {

...
public class ScryptParams extends ASN1Object {
    ...
    private ScryptParams(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 4 && aSN1Sequence.size() != 5) {
            throw new IllegalArgumentException(a.k(aSN1Sequence, new StringBuilder(StubApp.getString2(27146))));
        }
        this.salt = a.B(aSN1Sequence, 0);
    ...
    public ScryptParams(byte[] bArr, int i3, int i10, int i11) {
        this(bArr, BigInteger.valueOf(i3), BigInteger.valueOf(i10), BigInteger.valueOf(i11), (BigInteger) null);
    }

    public ScryptParams(byte[] bArr, int i3, int i10, int i11, int i12) {
        this(bArr, BigInteger.valueOf(i3), BigInteger.valueOf(i10), BigInteger.valueOf(i11), BigInteger.valueOf(i12));
    }

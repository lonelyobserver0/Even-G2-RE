...
public abstract class ASN1VisibleString extends ASN1Primitive implements ASN1String {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z2) throws IOException {
        aSN1OutputStream.writeEncodingDL(z2, 26, this.contents);
    }
    ...
    public ASN1VisibleString(byte[] bArr, boolean z2) {
        this.contents = z2 ? Arrays.clone(bArr) : bArr;
    }

    public static ASN1VisibleString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
        return (ASN1VisibleString) TYPE.getContextInstance(aSN1TaggedObject, z2);
    }
}

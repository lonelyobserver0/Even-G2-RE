...
public class CertTemplateBuilder {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int i3, boolean z2, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z2, i3, aSN1Encodable));
        }
    }
    ...
    public CertTemplateBuilder setVersion(int i3) {
        this.version = new ASN1Integer(i3);
        return this;
    }

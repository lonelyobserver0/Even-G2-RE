...
public class CertEtcToken extends ASN1Object implements ASN1Choice {
    ...
    public CertEtcToken(int i3, ASN1Encodable aSN1Encodable) {
        this.tagNo = i3;
    ...
    public static CertEtcToken[] arrayFromSequence(ASN1Sequence aSN1Sequence) {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            certEtcTokenArr[i3] = getInstance(aSN1Sequence.getObjectAt(i3));
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        int i3 = this.tagNo;
        return new DERTaggedObject(zArr[i3], i3, this.value);
    }

    public String toString() {
        return StubApp.getString2(27007) + this.value + StubApp.getString2(20170);
    }
    ...
    private CertEtcToken(ASN1TaggedObject aSN1TaggedObject) {
        ...
        switch (tagNo) {
            ...
            case 8:
                ...
                break;
            default:
                throw new IllegalArgumentException(StubApp.getString2(27006) + this.tagNo);
        }

...
public class GeneralNames extends ASN1Object {
    ...
    private GeneralNames(ASN1Sequence aSN1Sequence) {
        ...
        for (int i3 = 0; i3 != aSN1Sequence.size(); i3++) {
            this.names[i3] = GeneralName.getInstance(aSN1Sequence.getObjectAt(i3));
        }
    }
    ...
    public String toString() {
        StringBuffer stringBuffer = new StringBuffer(StubApp.getString2(27789));
        String lineSeparator = Strings.lineSeparator();
        stringBuffer.append(lineSeparator);
        for (int i3 = 0; i3 != this.names.length; i3++) {
            stringBuffer.append(StubApp.getString2(6147));
            stringBuffer.append(this.names[i3]);
            stringBuffer.append(lineSeparator);
        }
    ...
    public static GeneralNames getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
        return new GeneralNames(ASN1Sequence.getInstance(aSN1TaggedObject, z2));
    }

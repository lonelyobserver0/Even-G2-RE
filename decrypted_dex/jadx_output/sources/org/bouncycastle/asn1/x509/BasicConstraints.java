...
public class BasicConstraints extends ASN1Object {
    ...
    public BasicConstraints(int i3) {
        ...
        this.pathLenConstraint = new ASN1Integer(i3);
    }
    ...
    public String toString() {
        StringBuilder sb2;
        ASN1Integer aSN1Integer = this.pathLenConstraint;
        String string2 = StubApp.getString2(27716);
        if (aSN1Integer == null) {
            ...
            sb2 = new StringBuilder(string2);
            sb2.append(isCA());
            sb2.append(StubApp.getString2(27717));
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > 1) {
            if (this.cA == null) {
                throw new IllegalArgumentException(StubApp.getString2(27715));
            }

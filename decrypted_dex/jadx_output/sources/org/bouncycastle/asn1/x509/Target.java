...
public class Target extends ASN1Object implements ASN1Choice {
    ...
    public Target(int i3, GeneralName generalName) {
        this(new DERTaggedObject(i3, generalName));
    }
    ...
    public static Target getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(StubApp.getString2(26925) + obj.getClass());
    }
    ...
    private Target(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo == 0) {
            ...
            if (tagNo != 1) {
                throw new IllegalArgumentException(a.l(aSN1TaggedObject, new StringBuilder(StubApp.getString2(26884))));
            }

...
public class AuthorityKeyIdentifier extends ASN1Object {
    ...
    public AuthorityKeyIdentifier(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 0) {
                ...
                if (tagNo != 2) {
                    throw new IllegalArgumentException(StubApp.getString2(27100));
                }
    ...
    public String toString() {
        ASN1OctetString aSN1OctetString = this.keyidentifier;
        return a.k(StubApp.getString2(27714), aSN1OctetString != null ? Hex.toHexString(aSN1OctetString.getOctets()) : StubApp.getString2(1116), StubApp.getString2(74));
    }

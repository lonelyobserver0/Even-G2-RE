...
public class ObjectDigestInfo extends ASN1Object {
    ...
    public ObjectDigestInfo(int i3, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(i3);
        if (i3 == 2) {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i3 + 1));
        this.objectDigest = DERBitString.getInstance((Object) aSN1Sequence.getObjectAt(i3 + 2));
    }

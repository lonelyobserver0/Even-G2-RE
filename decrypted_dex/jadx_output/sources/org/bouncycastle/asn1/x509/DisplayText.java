...
public class DisplayText extends ASN1Object implements ASN1Choice {
    ...
    public DisplayText(int i3, String str) {
        str = str.length() > 200 ? str.substring(0, DISPLAY_TEXT_MAXIMUM_SIZE) : str;
        this.contentType = i3;
        this.contents = i3 != 0 ? i3 != 1 ? i3 != 2 ? i3 != 3 ? new DERUTF8String(str) : new DERVisibleString(str) : new DERUTF8String(str) : new DERBMPString(str) : new DERIA5String(str);
    }
    ...
    private DisplayText(ASN1String aSN1String) {
        ...
        if (aSN1String instanceof ASN1UTF8String) {
            ...
            if (!(aSN1String instanceof ASN1VisibleString)) {
                throw new IllegalArgumentException(StubApp.getString2(27737));
            }
            i3 = 3;
        }
        this.contentType = i3;

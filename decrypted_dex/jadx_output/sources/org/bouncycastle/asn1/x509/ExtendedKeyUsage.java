...
public class ExtendedKeyUsage extends ASN1Object {
    ...
    public KeyPurposeId[] getUsages() {
        ...
        while (objects.hasMoreElements()) {
            keyPurposeIdArr[i3] = KeyPurposeId.getInstance(objects.nextElement());
            i3++;
        }
    ...
    private ExtendedKeyUsage(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (!(aSN1Encodable.toASN1Primitive() instanceof ASN1ObjectIdentifier)) {
                throw new IllegalArgumentException(StubApp.getString2(27747));
            }
    ...
    public ExtendedKeyUsage(KeyPurposeId[] keyPurposeIdArr) {
        ...
        for (int i3 = 0; i3 != keyPurposeIdArr.length; i3++) {
            aSN1EncodableVector.add(keyPurposeIdArr[i3]);
            Hashtable hashtable = this.usageTable;
            KeyPurposeId keyPurposeId = keyPurposeIdArr[i3];

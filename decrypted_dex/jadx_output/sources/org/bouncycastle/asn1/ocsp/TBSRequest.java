...
public class TBSRequest extends ASN1Object {
    ...
    private static final ASN1Integer f18680V1 = new ASN1Integer(0);
    ...
    private TBSRequest(ASN1Sequence aSN1Sequence) {
        ...
        if ((aSN1Sequence.getObjectAt(0) instanceof ASN1TaggedObject) && ((ASN1TaggedObject) aSN1Sequence.getObjectAt(0)).getTagNo() == 0) {
            ...
            this.version = f18680V1;
        }
        if (aSN1Sequence.getObjectAt(i3) instanceof ASN1TaggedObject) {
            this.requestorName = GeneralName.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i3), true);
            i3++;
        }
        int i10 = i3 + 1;
        this.requestList = (ASN1Sequence) aSN1Sequence.getObjectAt(i3);
        if (aSN1Sequence.size() == i3 + 2) {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (!this.version.equals((ASN1Primitive) f18680V1) || this.versionSet) {

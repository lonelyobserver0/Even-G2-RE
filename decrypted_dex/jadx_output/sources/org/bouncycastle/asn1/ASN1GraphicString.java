...
public abstract class ASN1GraphicString extends ASN1Primitive implements ASN1String {
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z2) throws IOException {
        aSN1OutputStream.writeEncodingDL(z2, 25, this.contents);
    }
    ...
    public static ASN1GraphicString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z2) {
        return (ASN1GraphicString) TYPE.getContextInstance(aSN1TaggedObject, z2);
    }
}

...
public class KMACwithSHAKE128_params extends ASN1Object {
    ...
    public KMACwithSHAKE128_params(int i3) {
    ...
    public KMACwithSHAKE128_params(int i3, byte[] bArr) {
        this.outputLength = i3;
    ...
    private KMACwithSHAKE128_params(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() > 2) {
            throw new IllegalArgumentException(StubApp.getString2(27148));
        }
        if (aSN1Sequence.size() == 2) {
            this.outputLength = a.a(aSN1Sequence, 0);
            this.customizationString = a.B(aSN1Sequence, 1);
            ...
            this.outputLength = 256;
            this.customizationString = a.B(aSN1Sequence, 0);
        }
    }
}

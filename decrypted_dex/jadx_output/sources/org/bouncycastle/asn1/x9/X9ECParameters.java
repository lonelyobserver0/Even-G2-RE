...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f18717g;

    /* renamed from: h, reason: collision with root package name */
    private BigInteger f18718h;

    /* renamed from: n, reason: collision with root package name */
    private BigInteger f18719n;
    private byte[] seed;

    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        if (!(aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) || !((ASN1Integer) aSN1Sequence.getObjectAt(0)).hasValue(1)) {
            throw new IllegalArgumentException(StubApp.getString2(28000));
        }
        this.f18719n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        if (aSN1Sequence.size() == 6) {
            this.f18718h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
        X9Curve x9Curve = new X9Curve(X9FieldID.getInstance(aSN1Sequence.getObjectAt(1)), this.f18719n, this.f18718h, ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(2)));
        this.curve = x9Curve.getCurve();
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(3);
        if (objectAt instanceof X9ECPoint) {
            this.f18717g = (X9ECPoint) objectAt;
        } else {
            this.f18717g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f18717g);
        aSN1EncodableVector.add(new ASN1Integer(this.f18719n));
        if (this.f18718h != null) {
            aSN1EncodableVector.add(new ASN1Integer(this.f18718h));
        }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f18717g = x9ECPoint;
        this.f18719n = bigInteger;
        this.f18718h = bigInteger2;
        this.seed = Arrays.clone(bArr);
        if (ECAlgorithms.isFpCurve(eCCurve)) {
            x9FieldID = new X9FieldID(eCCurve.getField().getCharacteristic());
        } else {
            if (!ECAlgorithms.isF2mCurve(eCCurve)) {
                throw new IllegalArgumentException(StubApp.getString2(28002));
            }
            ...
            if (exponentsPresent.length == 3) {
                ...
                if (exponentsPresent.length != 5) {
                    throw new IllegalArgumentException(StubApp.getString2(28001));
                }

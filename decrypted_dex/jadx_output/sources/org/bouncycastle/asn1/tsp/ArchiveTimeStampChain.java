...
public class ArchiveTimeStampChain extends ASN1Object {
    ...
    public ArchiveTimeStampChain append(ArchiveTimeStamp archiveTimeStamp) {
        ...
        for (int i3 = 0; i3 != this.archiveTimestamps.size(); i3++) {
            aSN1EncodableVector.add(this.archiveTimestamps.getObjectAt(i3));
        }
    ...
    public ArchiveTimeStamp[] getArchiveTimestamps() {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            archiveTimeStampArr[i3] = ArchiveTimeStamp.getInstance(this.archiveTimestamps.getObjectAt(i3));
        }

...
public class ArchiveTimeStampSequence extends ASN1Object {
    ...
    public ArchiveTimeStampSequence append(ArchiveTimeStampChain archiveTimeStampChain) {
        ...
        for (int i3 = 0; i3 != this.archiveTimeStampChains.size(); i3++) {
            aSN1EncodableVector.add(this.archiveTimeStampChains.getObjectAt(i3));
        }
    ...
    public ArchiveTimeStampChain[] getArchiveTimeStampChains() {
        ...
        for (int i3 = 0; i3 != size; i3++) {
            archiveTimeStampChainArr[i3] = ArchiveTimeStampChain.getInstance(this.archiveTimeStampChains.getObjectAt(i3));
        }

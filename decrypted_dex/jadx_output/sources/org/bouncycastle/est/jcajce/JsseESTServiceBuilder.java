...
public class JsseESTServiceBuilder extends ESTServiceBuilder {
    ...
    public JsseESTServiceBuilder withKeyManager(KeyManager keyManager) {
        if (this.socketFactoryCreator != null) {
            throw new IllegalStateException(StubApp.getString2(29564));
        }
    ...
    public JsseESTServiceBuilder withTimeout(int i3) {
        this.timeoutMillis = i3;
        return this;
    }

    public JsseESTServiceBuilder(String str, int i3, X509TrustManager x509TrustManager) {
        super(str + StubApp.getString2(478) + i3);
        this.hostNameAuthorizer = new JsseDefaultHostnameAuthorizer(null);
        this.timeoutMillis = 0;
        this.supportedSuites = new HashSet();
        this.filterCipherSuites = true;
    ...
    public JsseESTServiceBuilder(String str, int i3, SSLSocketFactoryCreator sSLSocketFactoryCreator) {
        super(str + StubApp.getString2(478) + i3);
        this.hostNameAuthorizer = new JsseDefaultHostnameAuthorizer(null);
        this.timeoutMillis = 0;
        this.supportedSuites = new HashSet();
        ...
        if (sSLSocketFactoryCreator == null) {
            throw new NullPointerException(StubApp.getString2(29563));
        }
        this.socketFactoryCreator = sSLSocketFactoryCreator;
    }

    public JsseESTServiceBuilder(String str, int i3, X509TrustManager[] x509TrustManagerArr) {
        this(str + StubApp.getString2(478) + i3, x509TrustManagerArr);
    }

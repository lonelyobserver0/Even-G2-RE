...
public class ExtendedPKIXParameters extends PKIXParameters {
    ...
    public void setAttrCertCheckers(Set set) {
        ...
        while (it.hasNext()) {
            if (!(it.next() instanceof PKIXAttrCertChecker)) {
                throw new ClassCastException(h.k(PKIXAttrCertChecker.class, new StringBuilder(StubApp.getString2(35043)), StubApp.getString2(1)));
            }
        }
        this.attrCertCheckers.clear();
    ...
    public void setNecessaryACAttributes(Set set) {
        ...
        while (it.hasNext()) {
            if (!(it.next() instanceof String)) {
                throw new ClassCastException(StubApp.getString2(35044));
            }
        }
        this.necessaryACAttributes.clear();
    ...
    public void setStores(List list) {
        ...
        while (it.hasNext()) {
            if (!(it.next() instanceof Store)) {
                throw new ClassCastException(StubApp.getString2(35045));
            }
        }
    ...
    public void setTrustedACIssuers(Set set) {
        ...
        while (it.hasNext()) {
            if (!(it.next() instanceof TrustAnchor)) {
                throw new ClassCastException(h.k(TrustAnchor.class, new StringBuilder(StubApp.getString2(35043)), StubApp.getString2(1)));
            }
        }
        this.trustedACIssuers.clear();
    ...
    public void setValidityModel(int i3) {

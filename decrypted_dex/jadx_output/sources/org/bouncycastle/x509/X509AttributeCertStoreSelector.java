                ...
                if (!this.targetNames.isEmpty()) {
                    ...
                    for (Targets targets : targetsObjects) {
                        ...
                        while (true) {
                            ...
                            if (this.targetNames.contains(GeneralName.getInstance(targets2[i3].getTargetName()))) {
                                z2 = true;
                                break;
                            }
                            i3++;
            ...
            if (!this.targetGroups.isEmpty()) {
                ...
                for (Targets targets3 : targetsObjects) {
                    ...
                    while (true) {
                        ...
                        if (this.targetGroups.contains(GeneralName.getInstance(targets4[i10].getTargetGroup()))) {
                            z10 = true;
                            break;
                        }
                        i10++;

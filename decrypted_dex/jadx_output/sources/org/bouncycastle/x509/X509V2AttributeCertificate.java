...
public class X509V2AttributeCertificate implements X509AttributeCertificate {
    ...
    private static AttributeCertificate getObject(InputStream inputStream) throws IOException {
        try {
            ...
            throw new IOException(a.b(e11, new StringBuilder(StubApp.getString2(35157))));
        }
    }
    ...
    public X509Attribute[] getAttributes() {
        ...
        for (int i3 = 0; i3 != attributes.size(); i3++) {
            x509AttributeArr[i3] = new X509Attribute(attributes.getObjectAt(i3));
        }
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            return extension.getExtnValue().getEncoded(StubApp.getString2("26791"));
        } catch (Exception e10) {
    ...
    public final void verify(PublicKey publicKey, String str) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        if (!this.cert.getSignatureAlgorithm().equals(this.cert.getAcinfo().getSignature())) {
            throw new CertificateException(StubApp.getString2(35160));
        }
        ...
        try {
            ...
            if (!signature.verify(getSignature())) {
                throw new InvalidKeyException(StubApp.getString2(35158));
            }
        } catch (IOException unused) {
            throw new SignatureException(StubApp.getString2(35159));
        }
    }
    ...
    public X509V2AttributeCertificate(AttributeCertificate attributeCertificate) throws IOException {
        ...
        try {
            ...
            throw new IOException(StubApp.getString2(35156));
        }
    }
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.after(getNotAfter())) {
            throw new CertificateExpiredException(StubApp.getString2(30919) + getNotAfter());
        }
        if (date.before(getNotBefore())) {
            throw new CertificateNotYetValidException(StubApp.getString2(30918) + getNotBefore());
        }
    }
    ...
    public X509Attribute[] getAttributes(String str) {
        ...
        for (int i3 = 0; i3 != attributes.size(); i3++) {
            X509Attribute x509Attribute = new X509Attribute(attributes.getObjectAt(i3));

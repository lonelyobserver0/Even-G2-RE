...
public class NetscapeCertRequest extends ASN1Object {
    ...
    public NetscapeCertRequest(String str, AlgorithmIdentifier algorithmIdentifier, PublicKey publicKey) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchProviderException {
        ...
        try {
            ...
            throw new InvalidKeySpecException(StubApp.getString2(32531) + e10.toString());
        }
    }
    ...
    public boolean verify(String str) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
        ...
        Signature signature = Signature.getInstance(this.sigAlg.getAlgorithm().getId(), StubApp.getString2(21668));
    ...
    public NetscapeCertRequest(ASN1Sequence aSN1Sequence) {
        String string2 = StubApp.getString2(32532);
        String string22 = StubApp.getString2(32533);
        try {
            if (aSN1Sequence.size() != 3) {
                throw new IllegalArgumentException(string22 + aSN1Sequence.size());
            }
            ...
            if (aSN1Sequence2.size() != 2) {
                throw new IllegalArgumentException(string2 + aSN1Sequence2.size());
            }
            ...
            this.pubkey = KeyFactory.getInstance(algorithm.getAlgorithm().getId(), StubApp.getString2("21668")).generatePublic(x509EncodedKeySpec);
        } catch (Exception e10) {
    ...
    public void sign(PrivateKey privateKey, SecureRandom secureRandom) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException, InvalidKeySpecException {
        ...
        try {
            signature.update(new DERSequence(aSN1EncodableVector).getEncoded(StubApp.getString2("26791")));

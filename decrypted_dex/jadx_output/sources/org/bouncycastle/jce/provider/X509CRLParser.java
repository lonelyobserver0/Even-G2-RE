...
public class X509CRLParser extends X509StreamParserSpi {
    private static final PEMUtil PEM_PARSER = new PEMUtil(StubApp.getString2(30866));
    ...
    private CRL getCRL() throws CRLException {
        ...
        return new X509CRLObject(CertificateList.getInstance(aSN1Set2.getObjectAt(i3)));
    }

...
public class X509CRLEntryObject extends X509CRLEntry {
        ...
        try {
            ...
            for (int i3 = 0; i3 < names.length; i3++) {
                if (names[i3].getTagNo() == 4) {
                    return X500Name.getInstance(names[i3].getName());
                }
            }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f19156c.equals(((X509CRLEntryObject) obj).f19156c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f19156c.getEncoded(StubApp.getString2("26791"));
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new RuntimeException(a.b(e10, new StringBuilder(StubApp.getString2(32855))));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f19156c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f19156c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f19156c.getExtensions() != null;
    }
    ...
    public String toString() {
        Object generalNames;
        StringBuffer stringBuffer = new StringBuffer(StubApp.getString2(30889));
        String lineSeparator = Strings.lineSeparator();
        stringBuffer.append(getSerialNumber());
        stringBuffer.append(lineSeparator);
        stringBuffer.append(StubApp.getString2(30890));
        stringBuffer.append(getRevocationDate());
        stringBuffer.append(lineSeparator);
        stringBuffer.append(StubApp.getString2(30891));
        ...
        if (extensions != null) {
            ...
            if (oids.hasMoreElements()) {
                String string2 = StubApp.getString2(30892);
                loop0: while (true) {
                            ...
                            if (extension.getExtnValue() != null) {
                                ...
                                try {
                                    if (aSN1ObjectIdentifier.equals((ASN1Primitive) X509Extension.reasonCode)) {
                                        ...
                                        stringBuffer.append(StubApp.getString2("30894"));
                                    ...
                                    stringBuffer.append(aSN1ObjectIdentifier.getId());
                                    string2 = StubApp.getString2(30895);
                                }
                            }
                        }
                    }

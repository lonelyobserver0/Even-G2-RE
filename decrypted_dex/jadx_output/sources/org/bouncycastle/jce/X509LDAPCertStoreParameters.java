...
public class X509LDAPCertStoreParameters implements X509StoreParameters, CertStoreParameters {
    ...
    /* renamed from: org.bouncycastle.jce.X509LDAPCertStoreParameters$1, reason: invalid class name */
    ...
    public static class Builder {
        ...
        public X509LDAPCertStoreParameters build() {
            if (this.ldapUserCertificateAttributeName == null || this.ldapCACertificateAttributeName == null || this.ldapCrossCertificateAttributeName == null || this.ldapCertificateRevocationListAttributeName == null || this.ldapDeltaRevocationListAttributeName == null || this.ldapAuthorityRevocationListAttributeName == null || this.ldapAttributeCertificateAttributeAttributeName == null || this.ldapAACertificateAttributeName == null || this.ldapAttributeDescriptorCertificateAttributeName == null || this.ldapAttributeCertificateRevocationListAttributeName == null || this.ldapAttributeAuthorityRevocationListAttributeName == null || this.userCertificateSubjectAttributeName == null || this.cACertificateSubjectAttributeName == null || this.crossCertificateSubjectAttributeName == null || this.certificateRevocationListIssuerAttributeName == null || this.deltaRevocationListIssuerAttributeName == null || this.authorityRevocationListIssuerAttributeName == null || this.attributeCertificateAttributeSubjectAttributeName == null || this.aACertificateSubjectAttributeName == null || this.attributeDescriptorCertificateSubjectAttributeName == null || this.attributeCertificateRevocationListIssuerAttributeName == null || this.attributeAuthorityRevocationListIssuerAttributeName == null) {
                throw new IllegalArgumentException(StubApp.getString2(32528));
            }
        ...
        public Builder(String str, String str2) {
            ...
            this.userCertificateAttribute = StubApp.getString2(32513);
            this.cACertificateAttribute = StubApp.getString2(32514);
            this.crossCertificateAttribute = StubApp.getString2(32515);
            this.certificateRevocationListAttribute = StubApp.getString2(32516);
            this.deltaRevocationListAttribute = StubApp.getString2(32517);
            this.authorityRevocationListAttribute = StubApp.getString2(32518);
            this.attributeCertificateAttributeAttribute = StubApp.getString2(32519);
            this.aACertificateAttribute = StubApp.getString2(32520);
            this.attributeDescriptorCertificateAttribute = StubApp.getString2(32521);
            this.attributeCertificateRevocationListAttribute = StubApp.getString2(32522);
            this.attributeAuthorityRevocationListAttribute = StubApp.getString2(32523);
            String string2 = StubApp.getString2(27610);
            this.ldapUserCertificateAttributeName = string2;
            String string22 = StubApp.getString2(32524);
            this.ldapCACertificateAttributeName = string22;
            this.ldapCrossCertificateAttributeName = string22;
            this.ldapCertificateRevocationListAttributeName = string22;
            this.ldapDeltaRevocationListAttributeName = string22;
            this.ldapAuthorityRevocationListAttributeName = string22;
            this.ldapAttributeCertificateAttributeAttributeName = string2;
            String string23 = StubApp.getString2(32525);
            this.ldapAACertificateAttributeName = string23;
            this.ldapAttributeDescriptorCertificateAttributeName = string23;
            this.ldapAttributeCertificateRevocationListAttributeName = string23;
            this.ldapAttributeAuthorityRevocationListAttributeName = string23;
            this.userCertificateSubjectAttributeName = string2;
            String string24 = StubApp.getString2(32526);
            this.cACertificateSubjectAttributeName = string24;
            this.crossCertificateSubjectAttributeName = string24;
            this.certificateRevocationListIssuerAttributeName = string24;
            this.deltaRevocationListIssuerAttributeName = string24;
            this.authorityRevocationListIssuerAttributeName = string24;
            this.attributeCertificateAttributeSubjectAttributeName = string2;
            this.aACertificateSubjectAttributeName = string24;
            this.attributeDescriptorCertificateSubjectAttributeName = string24;
            this.attributeCertificateRevocationListIssuerAttributeName = string24;
            this.attributeAuthorityRevocationListIssuerAttributeName = string24;
            this.searchForSerialNumberIn = StubApp.getString2(32527);
        }
    }
    ...
    private int addHashCode(int i3, Object obj) {
    ...
    public static X509LDAPCertStoreParameters getInstance(LDAPCertStoreParameters lDAPCertStoreParameters) {
        return new Builder(StubApp.getString2(32529) + lDAPCertStoreParameters.getServerName() + StubApp.getString2(478) + lDAPCertStoreParameters.getPort(), "").build();
    }
    ...
    public /* synthetic */ X509LDAPCertStoreParameters(Builder builder, AnonymousClass1 anonymousClass1) {
        this(builder);
    }
}

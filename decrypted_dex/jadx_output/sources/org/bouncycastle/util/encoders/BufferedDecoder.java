...
public class BufferedDecoder {
    ...
    public int processByte(byte b2, byte[] bArr, int i3) {
        ...
        int decode = this.translator.decode(bArr2, 0, bArr2.length, bArr, i3);
        this.bufOff = 0;
        return decode;
    }
    ...
    public int processBytes(byte[] bArr, int i3, int i10, byte[] bArr2, int i11) {
        ...
        if (i10 > i13) {
            ...
            byte[] bArr5 = this.buf;
            int decode = translator.decode(bArr5, 0, bArr5.length, bArr2, i11);
            this.bufOff = 0;
            int i15 = i10 - i13;
            int i16 = i3 + i13;
            int length2 = i15 - (i15 % this.buf.length);
            bArr3 = bArr;
            i14 = decode + this.translator.decode(bArr3, i16, length2, bArr2, i11 + decode);
            i10 = i15 - length2;
            i3 = i16 + length2;
        } else {
            bArr3 = bArr;

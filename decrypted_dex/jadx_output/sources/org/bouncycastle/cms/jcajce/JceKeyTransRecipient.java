...
public abstract class JceKeyTransRecipient implements KeyTransRecipient {
    ...
    public Key extractSecretKey(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2, byte[] bArr) throws CMSException {
        boolean isGOST = CMSUtils.isGOST(algorithmIdentifier.getAlgorithm());
        String string2 = StubApp.getString2(28246);
        if (isGOST) {
            try {
                ...
                throw new CMSException(u.r(e10, new StringBuilder(string2)), e10);
            }
        }
        ...
        try {
            ...
            throw new CMSException(string2 + e11.getMessage(), e11);
        }
    }

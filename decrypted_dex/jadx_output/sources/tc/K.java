...
public final class K extends S9.i {
    ...
    public final Object b(S9.o reader) {
        ...
        while (true) {
            int g10 = reader.g();
            if (g10 == -1) {
                return new L((String) obj, z2, (C1756b) obj2, (J) obj3, reader.e(d8));
            }
            if (g10 == 1) {
    ...
    public final void d(S9.r writer, Object obj) {
        ...
        J j = value.f21291g;
        if (j != null) {
            J.f21283g.f(writer, 4, j);
        }
        C1756b c1756b = value.f21290f;
        if (c1756b != null) {
            C1756b.f21296e.f(writer, 3, c1756b);
        }
        boolean z2 = value.f21289e;
        if (z2) {
            S9.i.f6628f.f(writer, 2, Boolean.valueOf(z2));
        }
        String str = value.f21288d;
    ...
    public final void e(s2.d writer, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(writer, "writer");
        Intrinsics.checkNotNullParameter(value, "value");
        if (!Intrinsics.areEqual(value.f21288d, "")) {
            S9.i.f6635n.g(writer, 1, value.f21288d);
        }
        boolean z2 = value.f21289e;
        if (z2) {
    ...
    public final int h(Object obj) {
        ...
        J j = value.f21291g;
        return j != null ? J.f21283g.i(4, j) + e10 : e10;
    }
}
